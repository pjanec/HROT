...
/// <summary>
/// Bagira-IG implementation of <see cref="IEntityFilterFactory"/>.
///
/// <para>
...
///
/// <para>
/// <b>DIP / clean boundaries:</b> Only <c>Bagira.IG</c> knows about
/// <c>MapLayerRegistry</c> and <c>MapDisplayComponent</c>.
/// <c>FDP.Toolkit.Vis2D</c> only sees the <see cref="IEntityFilter"/> abstraction.
/// </para>
/// </summary>
public sealed class BagiraEntityFilterFactory : IEntityFilterFactory
{
    ...
    /// </param>
    public BagiraEntityFilterFactory(EntityRepository world)
    {
