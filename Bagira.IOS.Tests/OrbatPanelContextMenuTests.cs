...
/// or on mock <see cref="IIosLogic"/> interactions, so no ImGui context is required.</para>
/// </summary>
public class OrbatPanelContextMenuTests
{
    ...
    /// <summary>
    /// OC1-I001: left-clicking an entity row must call <see cref="IIosLogic.SelectEntity"/>.
    /// </summary>
    [Fact]
