...
public class UniqueNameGeneratorTests
{
    ...
    public void GetMaxIndex_SingleMatchingEntity_ReturnsItsIndex()
    {
        ...
        world.SetManagedComponent(e, new EntityInfo { Name = "Tank-3" });
    ...
    public void GetMaxIndex_MultipleMatchingEntities_ReturnsMaxIndex()
    {
        ...
        {
            var e = world.CreateEntity();
            world.SetManagedComponent(e, new EntityInfo { Name = name });
        }
    ...
    public void GetMaxIndex_MixedEntities_IgnoresNonMatchingPrefix()
    {
        ...
        world.SetManagedComponent(e1, new EntityInfo { Name = "Tank-3" });

        var e2 = world.CreateEntity();
        world.SetManagedComponent(e2, new EntityInfo { Name = "Truck-9" }); // different prefix
    ...
    public void GetMaxIndex_IsCaseInsensitive()
    {
        ...
        world.RegisterManagedComponent<EntityInfo>();
        var e = world.CreateEntity();
        world.SetManagedComponent(e, new EntityInfo { Name = "TANK-7" });
    ...
    public void GetMaxIndex_EntityWithNonNumericSuffix_IsIgnored()
    {
        ...
        world.RegisterManagedComponent<EntityInfo>();
        var e1 = world.CreateEntity();
        world.SetManagedComponent(e1, new EntityInfo { Name = "Tank-Alpha" }); // non-numeric suffix
        var e2 = world.CreateEntity();
        world.SetManagedComponent(e2, new EntityInfo { Name = "Tank-2" });
    ...
    public void CreateSessionGenerator_FirstCall_ReturnsPrefixPlusBaseIndexPlusOne()
    {
        ...
        world.RegisterManagedComponent<EntityInfo>();
        var e = world.CreateEntity();
        world.SetManagedComponent(e, new EntityInfo { Name = "Unit-4" });
