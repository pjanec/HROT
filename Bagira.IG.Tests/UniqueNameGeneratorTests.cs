...
public class UniqueNameGeneratorTests
{
    ...
    public void GetMaxIndex_SingleMatchingEntity_ReturnsItsIndex()
    {
        ...
        world.SetManagedComponent(e, new IgEntityData { Name = "Tank-3" });
    ...
    public void GetMaxIndex_MultipleMatchingEntities_ReturnsMaxIndex()
    {
        ...
        {
            var e = world.CreateEntity();
            world.SetManagedComponent(e, new IgEntityData { Name = name });
        }
    ...
    public void GetMaxIndex_MixedEntities_IgnoresNonMatchingPrefix()
    {
        ...
        world.SetManagedComponent(e1, new IgEntityData { Name = "Tank-3" });

        var e2 = world.CreateEntity();
        world.SetManagedComponent(e2, new IgEntityData { Name = "Truck-9" }); // different prefix
    ...
    public void GetMaxIndex_IsCaseInsensitive()
    {
        ...
        world.RegisterManagedComponent<IgEntityData>();
        var e = world.CreateEntity();
        world.SetManagedComponent(e, new IgEntityData { Name = "TANK-7" });
    ...
    public void GetMaxIndex_EntityWithNonNumericSuffix_IsIgnored()
    {
        ...
        world.RegisterManagedComponent<IgEntityData>();
        var e1 = world.CreateEntity();
        world.SetManagedComponent(e1, new IgEntityData { Name = "Tank-Alpha" }); // non-numeric suffix
        var e2 = world.CreateEntity();
        world.SetManagedComponent(e2, new IgEntityData { Name = "Tank-2" });
    ...
    public void CreateSessionGenerator_FirstCall_ReturnsPrefixPlusBaseIndexPlusOne()
    {
        ...
        world.RegisterManagedComponent<IgEntityData>();
        var e = world.CreateEntity();
        world.SetManagedComponent(e, new IgEntityData { Name = "Unit-4" });
