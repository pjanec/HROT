...
/// <summary>
/// Unit tests for Task IG.5.3: <see cref="MiniIosPanelState"/>.
///
/// Validates that <see cref="MiniIosPanelState.Submit"/> accurately maps
...
/// </summary>
public class MiniIosPanelStateTests
{
    ...
    {
        var bus   = CreateBus();
        var state = new MiniIosPanelState { TkbType = TkbTank };
    ...
    {
        var bus   = CreateBus();
        var state = new MiniIosPanelState { TkbType = tkbType };
