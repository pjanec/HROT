...
/// <param name="Vehicles">Whether the vehicles layer is visible.</param>
/// <param name="TacticalGraphics">Whether the tactical graphics (area overlays) layer is visible.</param>
/// <param name="RoadGraphs">Whether the road graphs (route entities) layer is visible.</param>
