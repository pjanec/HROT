...
2. `.dev/blueprint-canvas-parity/DESIGN.md` (read the **PINS ARE PROJECTION-ONLY** decision — it is mandatory).
...
- [ ] Report at `.dev/blueprint-canvas-parity/reports/BCP-BATCH-01-REPORT.md`.
