...
## Onboarding
1. `.dev/.guides/DEV-GUIDE_claude.md`; `.dev/blueprint-canvas-parity/DESIGN.md` (projection-only binds).
...
- [ ] Report at `.dev/blueprint-canvas-parity/reports/BCP-BATCH-03-REPORT.md`.
