...
1. **Design Document:** `.dev/blueprint-scenario/BLUEPRINT-SCENARIO-DESIGN.md` — §2 (NoSave principle), §4 (static assignment / translator), §11 (AssetId fix)
2. **Task Details:** `.dev/blueprint-scenario/TASK-DETAIL.md` — BSA-101 and BSA-202 sections
3. **Task Tracker:** `.dev/blueprint-scenario/TASK-TRACKER.md`
4. **Previous Review:** `.dev/blueprint-scenario/reviews/BATCH-01-REVIEW.md`
...
`.dev/blueprint-scenario/reports/BATCH-02-REPORT.md`
...
## 📚 Reference Materials
- **Design:** `.dev/blueprint-scenario/BLUEPRINT-SCENARIO-DESIGN.md` — §2, §4, §10, §11
- **Task Details:** `.dev/blueprint-scenario/TASK-DETAIL.md` — BSA-101 and BSA-202
