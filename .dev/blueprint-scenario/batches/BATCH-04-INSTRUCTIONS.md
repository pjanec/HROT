...
1. **Design Document:** `.dev/blueprint-scenario/BLUEPRINT-SCENARIO-DESIGN.md` — §7 (dynamic assignment), §10 (module placement)
2. **Task Details:** `.dev/blueprint-scenario/TASK-DETAIL.md` — BSA-301 section
...
`.dev/blueprint-scenario/reports/BATCH-04-REPORT.md`
