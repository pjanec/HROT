...
1. **Design Document:** `.dev/blueprint-scenario/BLUEPRINT-SCENARIO-DESIGN.md` — §4 (materialization steps), §5 (tier pre-provisioning + ceiling guard)
2. **Task Details:** `.dev/blueprint-scenario/TASK-DETAIL.md` — BSA-203 section
...
`.dev/blueprint-scenario/reports/BATCH-03-REPORT.md`
...
## 📚 Reference Materials
- **Design:** `.dev/blueprint-scenario/BLUEPRINT-SCENARIO-DESIGN.md` — §4, §5
- **Task Details:** `.dev/blueprint-scenario/TASK-DETAIL.md` — BSA-203
