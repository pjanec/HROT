...
1. **Design Document:** `.dev/blueprint-scenario/BLUEPRINT-SCENARIO-DESIGN.md` — §12.1 (Entity Inspector read-only monitoring), §12.4 (per-tier summary)
2. **Task Details:** `.dev/blueprint-scenario/TASK-DETAIL.md` — BSA-204 section
...
`.dev/blueprint-scenario/reports/BATCH-06-REPORT.md`
