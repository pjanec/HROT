...
1. **Design Document:** `.dev/blueprint-scenario/BLUEPRINT-SCENARIO-DESIGN.md` — §4.1 (Persist/Load flow E2E), §7 (dynamic assignment), §12 (editor UI)
2. **Task Details:** `.dev/blueprint-scenario/TASK-DETAIL.md` — BSA-401 and BSA-402 sections
...
`.dev/blueprint-scenario/reports/BATCH-08-REPORT.md`
