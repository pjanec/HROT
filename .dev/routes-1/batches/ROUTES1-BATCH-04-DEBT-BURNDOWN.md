...
**Target:** `Hrot.IG/Application/IgApplication.cs` and `Hrot.IG/Systems/RouteRenderLayer.cs`
**Descriptions:**
...
**Target:** `Hrot.IG/UI/WaypointEditorPanel.cs`
**Descriptions:**
...
**Target:** `Hrot.SimHost/Systems/Routing/RouteContextSystem.cs` and `Hrot.SimHost/Systems/SimHostTrajectoryLayer.cs`
**Descriptions:**
