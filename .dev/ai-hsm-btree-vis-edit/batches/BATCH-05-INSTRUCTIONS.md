...
3. **Task Details:** `.dev/ai-hsm-btree-vis-edit/TASK-DETAIL.md` — TASK-BB-1b-02, TASK-BB-1b-03
4. **Design:**
...
5. **Existing code to read before coding:**
   ...
   - `.dev/ai-hsm-btree-vis-edit/reviews/BATCH-04-REVIEW.md` — DEBT-02 description

### Report Submission

**When done, submit your report to:**
`.dev/ai-hsm-btree-vis-edit/reports/BATCH-05-REPORT.md`
...
Submit `.dev/ai-hsm-btree-vis-edit/reports/BATCH-05-REPORT.md`:
