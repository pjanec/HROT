...
3. **Task Details:** `.dev/ai-hsm-btree-vis-edit/TASK-DETAIL.md` — TASK-BB-1b-05, TASK-BB-1a-03, TASK-BB-1a-06
4. **Design:**
...
`.dev/ai-hsm-btree-vis-edit/reports/BATCH-04-REPORT.md`

**If you have questions, create:**
`.dev/ai-hsm-btree-vis-edit/questions/BATCH-04-QUESTIONS.md`
...
Submit `.dev/ai-hsm-btree-vis-edit/reports/BATCH-04-REPORT.md`:
