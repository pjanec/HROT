...
2. **Onboarding:** `.dev/ai-hsm-btree-vis-edit/ONBOARDING.md` — read this fully, especially section 3 (code locations)
3. **Task Details:** `.dev/ai-hsm-btree-vis-edit/TASK-DETAIL.md` — read §0 (Reconciliation) and Phase 0 section
4. **Design:** `.dev/ai-hsm-btree-vis-edit/Blackboard_Authoring_Detailed_Design.md` — sections §3.1, §4a.4, §6.3, §9.6, §14.5
...
`.dev/ai-hsm-btree-vis-edit/reports/BATCH-01-REPORT.md`

**If you have questions, create:**
`.dev/ai-hsm-btree-vis-edit/questions/BATCH-01-QUESTIONS.md`
...
Submit `.dev/ai-hsm-btree-vis-edit/reports/BATCH-01-REPORT.md` with:
...
- [ ] Report submitted to `.dev/ai-hsm-btree-vis-edit/reports/BATCH-01-REPORT.md`
