...
1. **BATCH-12 review:** `.dev/ai-hsm-btree-vis-edit/reviews/BATCH-12-REVIEW.md`
   — understand exactly which P2 items need fixing
2. **Task detail:** `.dev/ai-hsm-btree-vis-edit/TASK-DETAIL.md` §TASK-BB-1f-06
3. **Design:** `.dev/ai-hsm-btree-vis-edit/Blackboard_Authoring_Detailed_Design.md` §9.6
...
**When done:** `.dev/ai-hsm-btree-vis-edit/reports/BATCH-13-REPORT.md`
**Questions:** `.dev/ai-hsm-btree-vis-edit/questions/BATCH-13-QUESTIONS.md`
...
**Spec:** `.dev/ai-hsm-btree-vis-edit/TASK-DETAIL.md` §TASK-BB-1f-06; design §9.6.
