...
**Topic path:** `.dev/ai-hsm-btree-vis-edit/`
...
- `.dev/ai-hsm-btree-vis-edit/Blackboard_Authoring_Detailed_Design.md` — the spec for everything in this batch
- `.dev/ai-hsm-btree-vis-edit/reviews/BATCH-08-REVIEW.md` — what was reviewed and approved previously
- `.dev/ai-hsm-btree-vis-edit/DEBT-TRACKER.md` — known tech debt; do not make things worse
...
`.dev/ai-hsm-btree-vis-edit/reports/BATCH-09-REPORT.md`
