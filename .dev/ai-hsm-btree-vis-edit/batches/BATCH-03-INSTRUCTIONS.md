...
3. **Task Details:** `.dev/ai-hsm-btree-vis-edit/TASK-DETAIL.md` — TASK-BB-1b-04, TASK-BB-1b-01, TASK-BB-1b-06
4. **Design:**
...
5. **Previous reviews:**
   - `.dev/ai-hsm-btree-vis-edit/reviews/BATCH-01-REVIEW.md`
   - `.dev/ai-hsm-btree-vis-edit/reviews/BATCH-02-REVIEW.md`
...
`.dev/ai-hsm-btree-vis-edit/reports/BATCH-03-REPORT.md`

**If you have questions, create:**
`.dev/ai-hsm-btree-vis-edit/questions/BATCH-03-QUESTIONS.md`
...
Submit `.dev/ai-hsm-btree-vis-edit/reports/BATCH-03-REPORT.md`:
