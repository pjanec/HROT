...
**Batch file:** `.dev/test-health/batches/TH-1-INSTRUCTIONS.md`
...
### New documentation:
- `.dev/test-health/TEST-HEALTH.md` — full ledger
- `.dev/test-health/README.md` — filter command + convention
- `.dev/test-health/reports/TH-1-REPORT.md` — this report
