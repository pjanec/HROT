...
Resolved 2026-07-12 by code-grounded analysis (human architect unavailable; verified against source, not just the diagnostics). Each ruling says which side is correct + the fix + confidence. Companion: `.dev/test-health/diagnostics/*.md` (root causes), `TEST-HEALTH.md` (ledger).
