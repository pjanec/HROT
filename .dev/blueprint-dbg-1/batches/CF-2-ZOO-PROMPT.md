...
Also read the CF-1 diagnostic report at `.dev/blueprint-dbg-1/reports/CF1-NODE-IDENTITY-REPORT.md` — it tells you
...
Write `.dev/blueprint-dbg-1/reports/CF2-REPORT.md` with: what you changed (file-by-file), the exact `dotnet build` /
