...
2. **Design Addendum:** `.dev/blueprint-dbg-1/DEBUG-DD-ADDENDUM.md` — §4 (Instrumentation model), §2 (Node identity), §5 (Storage & lifecycle)
3. **Task Detail:** `.dev/blueprint-dbg-1/TASK-DETAIL.md` — Batch CF-7-rev section
...
### Report Submission
**When done, submit your report to:** `.dev/blueprint-dbg-1/reports/BATCH-CF7rev-REPORT.md`
...
## 📚 Reference Materials
- **Task Detail:** `.dev/blueprint-dbg-1/TASK-DETAIL.md` — Batch CF-7-rev section
- **Design Addendum:** `.dev/blueprint-dbg-1/DEBUG-DD-ADDENDUM.md` — §4 (Instrumentation model)
...
- **Task Tracker:** `.dev/blueprint-dbg-1/TASK-TRACKER.md`
