...
- Full spec for both tasks: `.dev/blueprint-dbg-1/TASK-DETAIL.md` (sections "Batch CF-4" and "Batch CF-5").
...
- Report → `.dev/blueprint-dbg-1/reports/CF4-REPORT.md`.
...
- Report → `.dev/blueprint-dbg-1/reports/CF5-REPORT.md`.
