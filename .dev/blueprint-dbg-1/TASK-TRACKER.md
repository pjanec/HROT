...
| CF-5 | **Step/Resume buttons in Blueprint Tools panel** — surface Continue / Step Over / Into / Out (enabled when paused) in the merged Blueprint Tools window, wired to session step/continue methods | C | ⬜ TODO (Zoo) | hit bp → press Continue/Step → sim resumes/advances one tick |
