...
**Detail:** `.dev/main-toolbar-2/TASK-DETAIL.md` (`MTB2-T4`) · DESIGN DEC-A4/A5/A6 + "Active-save-target model".
...
- Write `.dev/main-toolbar-2/reports/BATCH-33-REPORT.md`: seam signatures, the scenario-context rule, the dynamic
