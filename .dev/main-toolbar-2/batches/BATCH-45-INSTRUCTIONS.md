...
5. Report exact changes + final summary in `.dev/main-toolbar-2/reports/BATCH-45-REPORT.md`. No litter.
...
- `.dev/main-toolbar-2/reports/BATCH-45-REPORT.md`: per-bug change, files, test commands+results, any assertion updated.
