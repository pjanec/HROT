...
**Detail:** `.dev/main-toolbar-2/TASK-DETAIL.md` (section `MTB2-T1`) · **Design:** `.dev/main-toolbar-2/DESIGN.md` (DEC-A3)

## Onboarding (read first; do NOT use codebase-memory tooling)
1. `.dev/.guides/DEV-GUIDE.md` — engineering rules.
2. This file + the `MTB2-T1` section of `.dev/main-toolbar-2/TASK-DETAIL.md`.
...
- Write `.dev/main-toolbar-2/reports/BATCH-30-REPORT.md`: files changed, tests added, final test summary, and a note
