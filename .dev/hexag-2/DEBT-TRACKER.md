...
| HEXAG2-DEBT-005 | P3 | BATCH-01 review | Pre-existing audit test `ExConSubsystem_HasNoDirectClusterMasterReference` hard-codes wrong relative path to ExConSubsystem.cs. Should use absolute or workspace-relative path. | BATCH-03 | BATCH-03 |
