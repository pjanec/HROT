...
3. `.dev/blueprint-finalize/TASK-DETAIL.md` §"B-1" and §"B-2".
...
- Run the FULL suite (filtered per `.dev/test-health/README.md`); fix root causes; do not stop for permission.
