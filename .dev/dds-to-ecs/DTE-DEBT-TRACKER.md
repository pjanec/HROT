...
|---|---|---|---|---|---|
| DTE-DEBT-07-01 | P2 | DTE-BATCH-07 | `FireInteractionEvent` uses `EventId=3001` in both `Bagira.IG` and `Bagira.SimHost`, risking event-ID collisions in the aggregated Runner process. Reserve distinct IDs or centralize in a shared catalog. | Phase 15 | Open |
