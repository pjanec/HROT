...
2. `.dev/ai-debug-api/reviews/ADA-BATCH-09/10/11-REVIEW.md` (the live-reproduce gate; the false-green-verify
   recurring failure — RE-RUN `npm run verify` to a real tally before reporting).
3. **Design:** `.dev/ai-debug-api/DESIGN.md` — Group K (AI behavior traces) + New Work #1 (the arming seam).
4. **Task detail:** `.dev/ai-debug-api/TASK-DETAIL.md` — ADA-P6-T01, ADA-P6-T02.
...
- `.dev/ai-debug-api/reports/ADA-BATCH-12-REPORT.md` (DEV-GUIDE format): built, decisions/deviations, the
