...
2. `.dev/ai-debug-api/reviews/ADA-BATCH-06-REVIEW.md` + `ADA-BATCH-07-REVIEW.md` (gate discipline; full-build
   on ctor/interface change; the "prove the real thing on the live process" lesson).
3. **Design:** `.dev/ai-debug-api/DESIGN.md` — Group H (checkpoint/restore/diff, preview-run only) + the
   Run-Mode Model section.
4. **Task detail:** `.dev/ai-debug-api/TASK-DETAIL.md` — ADA-P3-T01, ADA-P3-T02 (authoritative + Success).
...
- `.dev/ai-debug-api/reports/ADA-BATCH-08-REPORT.md` (DEV-GUIDE format): built, decisions/deviations (incl.
