...
2. `.dev/main-toolbar-1/DESIGN.md` §10.6 (retirement) + §12 (relocated logic).
3. `.dev/main-toolbar-1/TASK-DETAIL.md` → MTB-P7-T2, MTB-P7-T4.
...
- Write `.dev/main-toolbar-1/reports/BATCH-22-REPORT.md`: types deleted + every reference removed,
