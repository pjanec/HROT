...
2. `.dev/main-toolbar-1/DESIGN.md` §18.2 (Save-As dialog) + §18.5 (identity rule — fresh AssetId).
3. `.dev/main-toolbar-1/TASK-DETAIL.md` → MTB-P6-T6.
...
- Write `.dev/main-toolbar-1/reports/BATCH-20-REPORT.md`: files changed, the fresh-id duplicate
