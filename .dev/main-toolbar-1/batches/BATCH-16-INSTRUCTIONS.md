...
2. `.dev/main-toolbar-1/DESIGN.md` §19 (scenario subfolders) + §10.5 (callers).
3. `.dev/main-toolbar-1/TASK-DETAIL.md` → MTB-P5-T5, MTB-P5-T6.
...
- Write `.dev/main-toolbar-1/reports/BATCH-16-REPORT.md`: files changed, the recursive enumeration
