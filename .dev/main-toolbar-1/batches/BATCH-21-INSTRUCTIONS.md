...
2. `.dev/main-toolbar-1/DESIGN.md` §12.1 (scenario menu) + §12.2 (Workspace submenu).
3. `.dev/main-toolbar-1/TASK-DETAIL.md` → MTB-P7-T1, MTB-P7-T3.
...
- Write `.dev/main-toolbar-1/reports/BATCH-21-REPORT.md`: files changed, the scenario command registrar
