...
2. `.dev/main-toolbar-1/DESIGN.md` §16 (Folder Reorganization) and §13 (Layering & Assembly Placement) — the rationale. Do **not** re-derive; just implement to it.
3. `.dev/main-toolbar-1/TASK-DETAIL.md` → "MTB-P0-T1 — `AssetRoots` constants" — the acceptance bar.
...
- Write `.dev/main-toolbar-1/reports/BATCH-01-REPORT.md` (template in DEV-GUIDE_claude.md §4):
