...
2. `.dev/main-toolbar-1/DESIGN.md` §10.4 (AssetKind.Scenario, contributor) and §19 (scenario nested paths context).
3. `.dev/main-toolbar-1/TASK-DETAIL.md` → MTB-P5-T2.
...
- Write `.dev/main-toolbar-1/reports/BATCH-13-REPORT.md`: files changed, the AssetKind switch audit
