...
2. `.dev/main-toolbar-1/DESIGN.md` §10.4 (typed change event; ReferenceCatalog ignores Scenario).
3. `.dev/main-toolbar-1/TASK-DETAIL.md` → MTB-P5-T1.
...
- Write `.dev/main-toolbar-1/reports/BATCH-14-REPORT.md`: files changed, the full subscriber list
