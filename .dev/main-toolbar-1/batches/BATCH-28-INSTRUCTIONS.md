...
2. **Design doc:** `.dev/main-toolbar-1/ASSET-PICKER-UX-DESIGN.md` — "Editor integration (assets as a NodeEdit
   picker source)" and **Decision D3**.
3. **Task definition:** `.dev/main-toolbar-1/TASK-DETAIL.md` → **`MTB-P8-T2`** (the acceptance bar).
4. **Decision context (read these rows):** `.dev/main-toolbar-1/DEBT-TRACKER.md` → **DEC-15** (why the
...
### Report Submission
When done, write `.dev/main-toolbar-1/reports/BATCH-28-REPORT.md`.
