...
2. `.dev/main-toolbar-1/DESIGN.md` §18.1 (FolderTreePicker), §10.2 (base-folder seam), §10.1 (tree
   construction context).
3. `.dev/main-toolbar-1/TASK-DETAIL.md` → MTB-P4-T1, MTB-P4-T2.
...
- Write `.dev/main-toolbar-1/reports/BATCH-10-REPORT.md`: files changed, which contributors got a
