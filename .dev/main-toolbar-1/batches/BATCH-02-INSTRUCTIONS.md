...
2. `.dev/main-toolbar-1/DESIGN.md` §16 (Folder Reorganization) — the target layout & rationale.
3. `.dev/main-toolbar-1/TASK-DETAIL.md` → "MTB-P0-T2" and "MTB-P0-T3" — the acceptance bars.
...
- Write `.dev/main-toolbar-1/reports/BATCH-02-REPORT.md`: list every file moved (old→new), every
