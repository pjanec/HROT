...
2. `.dev/main-toolbar-1/DESIGN.md` §18.4 (subfolder-aware save), §18.2 (dialogs), §18.5 (identity rule).
3. `.dev/main-toolbar-1/TASK-DETAIL.md` → MTB-P6-T7, MTB-P6-T5.
...
- Write `.dev/main-toolbar-1/reports/BATCH-19-REPORT.md`: files changed, the save-path helper +
