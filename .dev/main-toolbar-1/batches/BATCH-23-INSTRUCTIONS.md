...
2. `.dev/main-toolbar-1/DESIGN.md` §10.6 (retirement).
3. `.dev/main-toolbar-1/TASK-DETAIL.md` → MTB-P7-T5. **DEC-13 in DEBT-TRACKER.md** (peer-catalog salvage).
...
- Write `.dev/main-toolbar-1/reports/BATCH-23-REPORT.md`: types deleted + every reference removed/
