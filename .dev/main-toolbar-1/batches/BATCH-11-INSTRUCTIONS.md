...
2. `.dev/main-toolbar-1/DESIGN.md` §10.1 (AssetBrowserPanel), §10.2 (base-folder seam), §5.2 (kind icons).
3. `.dev/main-toolbar-1/TASK-DETAIL.md` → MTB-P4-T3.
...
- Write `.dev/main-toolbar-1/reports/BATCH-11-REPORT.md`: files changed, the logic/draw split + model
