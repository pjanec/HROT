...
2. `.dev/main-toolbar-1/DESIGN.md` §9 (AI Debug Group, polymorphic).
3. `.dev/main-toolbar-1/TASK-DETAIL.md` → MTB-P3-T5.
...
- Write `.dev/main-toolbar-1/reports/BATCH-09-REPORT.md`: chosen assembly + why (layering), the
