...
- [ ] **MTB-P3-T1** Extract `TransportIcons` helper [details](./TASK-DETAIL.md#mtb-p3-t1--extract-transporticons-helper)
- [ ] **MTB-P3-T2** `MainToolbarTimeControlSection` [details](./TASK-DETAIL.md#mtb-p3-t2--maintoolbartimecontrolsection)
