...
**Onboarding (read in order):** `.dev/.guides/DEV-GUIDE_claude.md`; `docs/blueprints/Blueprint_Subsystem_Debug_NodeGranularStepping_Addendum.md`; the BPDBG-PERNODE-PROBES report `.dev/blueprint-dbg-2/reports/BPDBG-PERNODE-PROBES-REPORT.md`; the BPDBG-STEPOVER-LATENT-SEQUENCE report `.dev/blueprint-dbg-2/reports/BPDBG-STEPOVER-LATENT-SEQUENCE-REPORT.md`; this file. You MAY use codebase-memory MCP first.
**DO NOT COMMIT.** Report to `.dev/blueprint-dbg-2/reports/BPDBG-SEQ-PROBE-ORDER-REPORT.md`. Lead reviews + commits.
