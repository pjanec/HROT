...
2. `.dev/blueprint-dbg-2/PLAN.md` + `docs/blueprints/Blueprint_Subsystem_Debug_NodeGranularStepping_Addendum.md` (§3.4 is this feature).
3. `.dev/blueprint-dbg-2/reviews/BATCH-03-REVIEW.md` / `BATCH-04-REVIEW.md`.
4. This file.
