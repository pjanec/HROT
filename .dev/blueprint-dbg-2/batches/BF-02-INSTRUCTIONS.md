...
- Do NOT commit. Write a short report to `.dev/blueprint-dbg-2/reports/BF-02-REPORT.md` (the change, the test, the exact `dotnet test` summary line). The lead reviews and commits.
