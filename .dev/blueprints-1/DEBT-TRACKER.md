...
| DEBT-019 | BATCH-16 review | `DebugProbe.Sink` is a mutable process-wide static. Parallel xUnit test classes can interfere if they set/clear Sink concurrently. Add [Collection("DebugProbe")] isolation group in DBG-006 test suite. | P3 | BATCH-20 (DBG-006) | OPEN |
