...
- [x] **SM-010** Refactor `IgApplication` to use `SharedApplicationBootstrapper` (all IG tests green) [details](./TASK-DETAILS.md#sm-010--refactor-igapplication-to-use-sharedapplicationbootstrapper)
