...
**Restate & obey the Working Agreement** in `.dev/quick-reload/TASK-TRACKER.md` (one task; no cheating; finish until
...
- `TriggerFromSourcesAsync` added (Steps 2.5–7, parameterized, multi-source); `TriggerAsync` delegates to it after
  ...
  test green. Build 0 warnings. Write `.dev/quick-reload/reports/BATCH-QR-02-REPORT.md`.
