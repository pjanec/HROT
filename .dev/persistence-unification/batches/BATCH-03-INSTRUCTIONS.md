...
3. `.dev/persistence-unification/TASK-DETAIL.md` — PU-201, PU-202, PU-205 success conditions.
4. `.dev/persistence-unification/reviews/BATCH-01-REVIEW.md` + `BATCH-02-REVIEW.md`.
...
- [ ] Report → `.dev/persistence-unification/reports/BATCH-03-REPORT.md`.
