...
2. `.dev/persistence-unification/BTree_HSM_JSON_Persistence_Detailed_Design.md` — **§3 (D5)** (base-name collision: a `.cs` and a `.json` must not share a base name in the same location) and **§9**. Cite D5.
3. `.dev/persistence-unification/TASK-DETAIL.md` — PU-502 success conditions.
...
- [ ] Report → `.dev/persistence-unification/reports/BATCH-07-REPORT.md`.
