...
2. `.dev/persistence-unification/BTree_HSM_JSON_Persistence_Detailed_Design.md` — **§8** (Save-All, FlushNow, Ctrl+Shift+S, flush-on-close; "C# regeneration stays a separate build/on-demand step"), §5.2 (projection-only). Cite.
3. `.dev/persistence-unification/TASK-DETAIL.md` — PU-601/602/603 success conditions.
...
- [ ] Report → `.dev/persistence-unification/reports/BATCH-06-REPORT.md`.
