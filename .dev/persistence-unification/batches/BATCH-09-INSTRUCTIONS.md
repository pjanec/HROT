...
**Dependencies:** BATCH-08 (PU-401: blob-equivalence PROVEN; validated migration JSON staged in `.dev/persistence-unification/migration-artifacts/`). **PU-D06 RESOLVED.**
...
- `git mv .dev/persistence-unification/migration-artifacts/SampleScout.btree.json Hrot/Subsystems/Hrot.AI.Behaviors/Trees/SampleScout.btree.json`
- `git mv .dev/persistence-unification/migration-artifacts/Machines/SampleGuard.hsm.json Hrot/Subsystems/Hrot.AI.Behaviors/Machines/SampleGuard.hsm.json`
...
- [ ] Report → `.dev/persistence-unification/reports/BATCH-09-REPORT.md`.
