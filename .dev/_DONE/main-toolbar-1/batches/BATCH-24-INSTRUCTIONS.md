...
2. `.dev/_DONE/main-toolbar-1/DESIGN.md` §4 (toolbar), §7 (time group), §8 (perspective group), §9 (AI-debug group).
...
- Write `.dev/_DONE/main-toolbar-1/reports/BATCH-24-REPORT.md`: what was wired (group → sortOrder), the time
