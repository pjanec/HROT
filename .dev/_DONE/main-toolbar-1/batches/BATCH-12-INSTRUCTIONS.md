...
2. `.dev/_DONE/main-toolbar-1/DESIGN.md` §10.1 ("All" tab, incremental filter, last-opened memory).
3. `.dev/_DONE/main-toolbar-1/TASK-DETAIL.md` → MTB-P4-T4, MTB-P4-T5.
...
- Write `.dev/_DONE/main-toolbar-1/reports/BATCH-12-REPORT.md`: files changed, the filter/chip/expand
