...
2. `.dev/_DONE/main-toolbar-1/DESIGN.md` §18.3 (per-kind minting), §18.1 (FolderTreePicker pick mode), §19 (scenario).
3. `.dev/_DONE/main-toolbar-1/TASK-DETAIL.md` → MTB-P6-T3, MTB-P6-T4.
...
- Write `.dev/_DONE/main-toolbar-1/reports/BATCH-18-REPORT.md`: files changed, each per-kind impl's
