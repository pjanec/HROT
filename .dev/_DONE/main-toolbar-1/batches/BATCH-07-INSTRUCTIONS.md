...
2. `.dev/_DONE/main-toolbar-1/DESIGN.md` §7 (Time Control Group).
3. `.dev/_DONE/main-toolbar-1/TASK-DETAIL.md` → MTB-P3-T1, MTB-P3-T2.
...
- Write `.dev/_DONE/main-toolbar-1/reports/BATCH-07-REPORT.md`: files changed, where TransportIcons/FormatRate
