...
2. **Design doc:** `.dev/_DONE/main-toolbar-1/ASSET-PICKER-UX-DESIGN.md` — "Editor integration", **Decisions D3/D4**.
3. **Task definition:** `.dev/_DONE/main-toolbar-1/TASK-DETAIL.md` → **`MTB-P8-T3`** (acceptance bar).
4. **Decision context:** `.dev/_DONE/main-toolbar-1/DEBT-TRACKER.md` → **DEC-15** (why we open via the entry-driven
...
### Report Submission
When done, write `.dev/_DONE/main-toolbar-1/reports/BATCH-29-REPORT.md`.
