...
2. `.dev/_DONE/main-toolbar-1/DESIGN.md` §4.1.2 (Window placement & dockspace integration).
3. `.dev/_DONE/main-toolbar-1/TASK-DETAIL.md` → MTB-P1-T3.
...
- Write `.dev/_DONE/main-toolbar-1/reports/BATCH-04-REPORT.md`: files changed, the new tests + assertions,
