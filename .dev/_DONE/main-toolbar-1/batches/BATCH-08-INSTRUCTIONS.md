...
2. `.dev/_DONE/main-toolbar-1/DESIGN.md` §8 (Perspective Group & Menu).
3. `.dev/_DONE/main-toolbar-1/TASK-DETAIL.md` → MTB-P3-T3, MTB-P3-T4.
...
- Write `.dev/_DONE/main-toolbar-1/reports/BATCH-08-REPORT.md`: files changed, the testable seams used,
