...
2. `.dev/_DONE/main-toolbar-1/DESIGN.md` §10.3 (hosts: modal picker + docked window).
3. `.dev/_DONE/main-toolbar-1/TASK-DETAIL.md` → MTB-P5-T3, MTB-P5-T4.
...
- Write `.dev/_DONE/main-toolbar-1/reports/BATCH-15-REPORT.md`: files changed, the open/activate/cancel
