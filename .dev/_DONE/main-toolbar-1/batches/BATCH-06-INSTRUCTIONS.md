...
2. `.dev/_DONE/main-toolbar-1/DESIGN.md` §20 (Save Commands & the Ctrl+S Fix) + §6.3 (hotkey dispatch).
3. `.dev/_DONE/main-toolbar-1/TASK-DETAIL.md` → MTB-P2-T4.
...
- Write `.dev/_DONE/main-toolbar-1/reports/BATCH-06-REPORT.md`: files changed, where the perspective-level
