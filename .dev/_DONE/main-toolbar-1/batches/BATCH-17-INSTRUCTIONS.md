...
2. `.dev/_DONE/main-toolbar-1/DESIGN.md` §17 (recipe model; in-code "Empty") + §18.3 (per-kind minting).
3. `.dev/_DONE/main-toolbar-1/TASK-DETAIL.md` → MTB-P6-T1, MTB-P6-T2.
...
- Write `.dev/_DONE/main-toolbar-1/reports/BATCH-17-REPORT.md`: files changed, the shared-vs-Compiler
