...
2. **Design doc:** `.dev/_DONE/main-toolbar-1/ASSET-PICKER-UX-DESIGN.md` — read **"The only code gaps (in NodeEdit `TreeLayout`)"** and **Decisions D1/D2**.
3. **Task definition:** `.dev/_DONE/main-toolbar-1/TASK-DETAIL.md` → section **`MTB-P8-T1`** (the acceptance bar).
...
### Report Submission
When done, write `.dev/_DONE/main-toolbar-1/reports/BATCH-27-REPORT.md`.
