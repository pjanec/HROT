...
2. `.dev/_DONE/main-toolbar-1/DESIGN.md` §4 (Main Toolbar Framework) and §5 (Icon Infrastructure).
3. `.dev/_DONE/main-toolbar-1/TASK-DETAIL.md` → MTB-P1-T1, MTB-P1-T2, MTB-P1-T4.
...
- Write `.dev/_DONE/main-toolbar-1/reports/BATCH-03-REPORT.md`: files changed, every new test + what it
