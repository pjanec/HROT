...
2. `.dev/_DONE/main-toolbar-1/DESIGN.md` §4.1 (note: §4.1.2's separate-band placement is being revised here).
3. Current code:
...
- Write `.dev/_DONE/main-toolbar-1/reports/BATCH-25-REPORT.md`: the inline-render approach, the frame-height
