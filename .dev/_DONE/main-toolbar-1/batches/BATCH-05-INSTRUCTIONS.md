...
2. `.dev/_DONE/main-toolbar-1/DESIGN.md` §6 (Editor Action System Integration), esp. §6.1 + §6.2.
3. `.dev/_DONE/main-toolbar-1/TASK-DETAIL.md` → MTB-P2-T1, T2, T3.
...
- Write `.dev/_DONE/main-toolbar-1/reports/BATCH-05-REPORT.md`: files changed, where you placed the shell
