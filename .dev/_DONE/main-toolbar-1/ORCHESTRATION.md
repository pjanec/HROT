...
- Design rationale: .dev/_DONE/main-toolbar-1/DESIGN.md  (sections: <§refs>)
- Engineering rules you MUST follow: .dev/.guides/DEV-GUIDE.md
- This batch's spec: .dev/_DONE/main-toolbar-1/batches/BATCH-<NN>-<slug>.md
