...
**Detail:** `.dev/_DONE/main-toolbar-2/TASK-DETAIL.md` (`MTB2-T6`) · DECISIONS D-T6-1. **Mirrors Phase-8 `AssetPickerSource`.**
...
- Write `.dev/_DONE/main-toolbar-2/reports/BATCH-35-REPORT.md`: shape, files changed, tests, final summary.
