...
**Detail:** `.dev/_DONE/main-toolbar-2/TASK-DETAIL.md` (`MTB2-T5`) · DESIGN DEC-A7. **Depends:** MTB2-T4 (scenario commands).
...
- Write `.dev/_DONE/main-toolbar-2/reports/BATCH-34-REPORT.md`: files changed, menu paths added, tests, final summaries.
