...
**Detail:** `.dev/_DONE/main-toolbar-2/TASK-DETAIL.md` (`MTB2-T7`) · DECISIONS D-T7-1 · **Mirrors Phase-8 `AssetPickerLauncher`.**
...
- Write `.dev/_DONE/main-toolbar-2/reports/BATCH-36-REPORT.md`: launcher shape, the showNewAssetDialog create wiring + the
