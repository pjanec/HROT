...
**Detail:** `.dev/_DONE/main-toolbar-2/TASK-DETAIL.md` (`MTB2-T3`) · DECISIONS D-T3-1.
...
- The 4 named tests pass; build 0 warnings; `NodeEditor.Core.Tests` `Failed: 0`; filtered `Fdp.Presentation.Tests`
  `Failed: 0`.
- Write `.dev/_DONE/main-toolbar-2/reports/BATCH-32-REPORT.md`: files changed, tests added, final summaries.
