...
2. `.dev/_DONE/blueprint-dbg-2/PLAN.md`.
3. `.dev/_DONE/blueprint-dbg-2/reviews/BATCH-02-REVIEW.md` (Corrective Task 0 below comes from here) + `reports/BATCH-02-REPORT.md`.
4. This file.
