...
- Do NOT commit. Write a short report to `.dev/_DONE/blueprint-dbg-2/reports/BF-01-REPORT.md` (what you changed, the test, the exact `dotnet test` summary line). The lead reviews and commits.
