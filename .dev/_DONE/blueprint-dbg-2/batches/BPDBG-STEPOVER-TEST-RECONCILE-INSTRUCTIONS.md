...
**Onboarding:** `.dev/.guides/DEV-GUIDE_claude.md`; the two prior reports `.dev/_DONE/blueprint-dbg-2/reports/BPDBG-STEPOVER-LATENT-SEQUENCE-REPORT.md` and `BPDBG-SEQ-PROBE-ORDER-REPORT.md`; this file. **DO NOT COMMIT.** Report → `.dev/_DONE/blueprint-dbg-2/reports/BPDBG-STEPOVER-TEST-RECONCILE-REPORT.md`.
