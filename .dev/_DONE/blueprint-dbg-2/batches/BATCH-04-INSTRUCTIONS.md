...
2. `.dev/_DONE/blueprint-dbg-2/PLAN.md` + `docs/blueprints/Blueprint_Subsystem_Debug_NodeGranularStepping_Addendum.md` (the feature).
3. `.dev/_DONE/blueprint-dbg-2/reviews/BATCH-03-REVIEW.md` (what the session already exposes).
4. This file.
