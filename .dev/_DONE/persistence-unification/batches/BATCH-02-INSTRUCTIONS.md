...
3. `.dev/_DONE/persistence-unification/TASK-DETAIL.md` — **PU-101** success conditions (read verbatim — the byte-identical gate is exact), and PU-105.
4. `.dev/_DONE/persistence-unification/reviews/BATCH-01-REVIEW.md` + `reports/BATCH-01-REPORT.md` — the DTO/mapper shape you build on.
