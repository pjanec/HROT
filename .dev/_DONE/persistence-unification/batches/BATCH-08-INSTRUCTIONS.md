...
2. `.dev/_DONE/persistence-unification/BTree_HSM_JSON_Persistence_Detailed_Design.md` — **§11 (migration)**, §6.4/§6.5, §3 (D1, D14). Cite. (Note: the byte-identical wording is SUPERSEDED by PU-D06 → blob/behavioral; cite that.)
3. `.dev/_DONE/persistence-unification/TASK-DETAIL.md` — PU-401 success conditions.
