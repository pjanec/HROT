...
**Dependencies:** BATCH-09 (assets migrated to JSON). Root-cause analysis: `.dev/_DONE/persistence-unification/SMOKE-FINDINGS.md` (read it).
...
2. `.dev/_DONE/persistence-unification/SMOKE-FINDINGS.md` — the symptom→cause table.
