...
1. **Design Addendum:** `.dev/_DONE/blueprint-dbg-1/DEBUG-DD-ADDENDUM.md` — §7 (Session persistence), §5 (Storage & lifecycle)
2. **Task Detail:** `.dev/_DONE/blueprint-dbg-1/TASK-DETAIL.md` — Batch CF-8 section
...
### Report Submission
`.dev/_DONE/blueprint-dbg-1/reports/BATCH-CF8-REPORT.md`
...
- **Design Addendum §7:** `.dev/_DONE/blueprint-dbg-1/DEBUG-DD-ADDENDUM.md`
