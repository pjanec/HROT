...
- **DESIGN OF RECORD: `.dev/_DONE/blueprint-dbg-1/DEBUG-DD-ADDENDUM.md`** — read the cited sections before coding; it is
  authoritative. Full task detail: `.dev/_DONE/blueprint-dbg-1/TASK-DETAIL.md` (sections CF-6 / CF-7-rev / CF-8). Where a
...
`.dev/_DONE/blueprint-dbg-1/reports/CF6-REPORT.md`.
...
`.dev/_DONE/blueprint-dbg-1/reports/CF7rev-REPORT.md`.
...
`.dev/_DONE/blueprint-dbg-1/reports/CF8-REPORT.md`.
