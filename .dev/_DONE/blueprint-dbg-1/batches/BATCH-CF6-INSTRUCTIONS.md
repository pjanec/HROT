...
### Required Reading
1. **Design Addendum:** `.dev/_DONE/blueprint-dbg-1/DEBUG-DD-ADDENDUM.md` — §6 (Stepping)
2. **Task Detail:** `.dev/_DONE/blueprint-dbg-1/TASK-DETAIL.md` — Batch CF-6 section
...
### Report Submission
`.dev/_DONE/blueprint-dbg-1/reports/BATCH-CF6-REPORT.md`
