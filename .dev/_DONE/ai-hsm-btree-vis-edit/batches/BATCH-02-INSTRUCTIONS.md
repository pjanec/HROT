...
2. **Onboarding:** `.dev/_DONE/ai-hsm-btree-vis-edit/ONBOARDING.md` — especially section 3 (code locations) and section 4 (building)
3. **Task Details:** `.dev/_DONE/ai-hsm-btree-vis-edit/TASK-DETAIL.md` — §0 (Reconciliation) then Phase 1.5a entries for TASK-BB-1a-01, 02, 04, 05
4. **Design:** `.dev/_DONE/ai-hsm-btree-vis-edit/Blackboard_Authoring_Detailed_Design.md`:
...
5. **Previous review:** `.dev/_DONE/ai-hsm-btree-vis-edit/reviews/BATCH-01-REVIEW.md`
...
`.dev/_DONE/ai-hsm-btree-vis-edit/reports/BATCH-02-REPORT.md`

**If you have questions, create:**
`.dev/_DONE/ai-hsm-btree-vis-edit/questions/BATCH-02-QUESTIONS.md`
...
Submit `.dev/_DONE/ai-hsm-btree-vis-edit/reports/BATCH-02-REPORT.md` with:
