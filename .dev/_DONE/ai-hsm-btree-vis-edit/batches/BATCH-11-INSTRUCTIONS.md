...
- **Main design:** `.dev/_DONE/ai-hsm-btree-vis-edit/Blackboard_Authoring_Detailed_Design.md`  
  Key sections: BB §8.2 (workflow), §8.3 (emit), §8.4 (per-subtree DTO), §8.7 (ordering), §14.6 (layout persistence)
- **Task detail:** `.dev/_DONE/ai-hsm-btree-vis-edit/TASK-DETAIL.md` — sections 1e-03, 1e-04, 1e-05
...
Write the completion report to: `.dev/_DONE/ai-hsm-btree-vis-edit/reports/BATCH-11-REPORT.md`
