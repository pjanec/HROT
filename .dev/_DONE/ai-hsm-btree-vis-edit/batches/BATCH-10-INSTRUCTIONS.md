...
1. **Design:** `.dev/_DONE/ai-hsm-btree-vis-edit/Blackboard_Authoring_Detailed_Design.md` — §8 (Approach B field sync), §9.6 (BlackboardAccess annotations), §13 (failure modes A/B/C/D), §14 (infrastructure additions)
2. **Task detail:** `.dev/_DONE/ai-hsm-btree-vis-edit/TASK-DETAIL.md` — tasks 1f-07, 1e-01, 1e-02 and DEBT-06
3. **BATCH-09 review:** `.dev/_DONE/ai-hsm-btree-vis-edit/reviews/BATCH-09-REVIEW.md`
...
Write the completion report to: `.dev/_DONE/ai-hsm-btree-vis-edit/reports/BATCH-10-REPORT.md`
