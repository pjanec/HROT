...
**File:** `Hrot.Map.Common/HrotEnvironment.cs`  
...
Centralizes common setup parameters for SimHost, IG, and IOS through a shared HrotEnvironment component.

- Created HrotEnvironment to uniformize TKB, GeoTransform, and DDS Domain setups.
...
Note: HrotEnvironment currently uses reflection for TKB registration to avoid circular dependencies. This architecture violation will be cleaned up in the next iteration.
