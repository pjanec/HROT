...
| SIM-DEBT-04 | P3 | `MissionAdapterSystem` | Unregistered BehaviorId string logs warning continuously. Implement Idle fallback behavior (`SimHostBehaviorIds.Idle_HSM = 3010`) to prevent log-spam. | TBD | Open |
