...
2. `.dev/_DONE/btree-ai-action-binding/SLICE2-DESIGN.md` §10 Flaw 2 (the mandated fix) + §9 hot-reload.
3. `.dev/_DONE/btree-ai-action-binding/TASK-DETAIL.md` §S2-3 — the two named tests + exact assertions.
4. `.dev/_DONE/btree-ai-action-binding/reviews/BATCH-06-REVIEW.md` (DEBT-AIB-027 note) + the S2-2 provisioning helpers you will modify.
...
- [ ] Report at `.dev/_DONE/btree-ai-action-binding/reports/BATCH-08-REPORT.md`.
