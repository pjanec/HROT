...
3. `.dev/_DONE/btree-ai-action-binding/SLICE1-DESIGN.md` §3.1 (whole-DTO binding), §3.2.
4. `.dev/_DONE/btree-ai-action-binding/reviews/BATCH-02-REVIEW.md` — how S1-2/S1-3 currently work (single-offset-source via `BTreeBlackboardPackHelper`).
5. `.dev/_DONE/btree-ai-action-binding/TASK-DETAIL.md` §S1-2b (success conditions / named tests).
...
## Report Requirements (`.dev/_DONE/btree-ai-action-binding/reports/BATCH-03-REPORT.md`)
