...
- Plan/checklist: [`.dev/_DONE/btree-ai-action-binding/TASK-TRACKER.md`](./TASK-TRACKER.md) (Slice 3 section)
- Per-batch specs + test conditions: [`.dev/_DONE/btree-ai-action-binding/TASK-DETAIL.md`](./TASK-DETAIL.md) (S3-1 … S3-G)
...
Test-health items left intentionally red — tracker: [`.dev/_DONE/test-health/DEFERRED-ITEMS.md`](../test-health/DEFERRED-ITEMS.md):
