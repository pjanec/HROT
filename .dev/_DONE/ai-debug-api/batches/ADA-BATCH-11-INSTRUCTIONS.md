...
2. `.dev/_DONE/ai-debug-api/reviews/ADA-BATCH-09-REVIEW.md` + `ADA-BATCH-10-REVIEW.md` (the live-reproduce gate).
3. **Design:** `.dev/_DONE/ai-debug-api/DESIGN.md` — Group J (logs) + Group B (queries / filter).
4. **Task detail:** `.dev/_DONE/ai-debug-api/TASK-DETAIL.md` — ADA-P5-T01, ADA-P7-T01.
...
- `.dev/_DONE/ai-debug-api/reports/ADA-BATCH-11-REPORT.md` (DEV-GUIDE format): built, decisions (level/since
