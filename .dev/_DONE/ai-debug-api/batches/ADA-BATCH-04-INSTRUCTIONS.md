...
2. `.dev/_DONE/ai-debug-api/reviews/ADA-BATCH-02-REVIEW.md` (patterns + path-naming note) and `ADA-BATCH-03-REVIEW.md`.
3. **Design:** `.dev/_DONE/ai-debug-api/DESIGN.md` — Group F (entity commands + discovery), Group B (`/components`),
   *Wait-Gating Semantics (command results)*.
4. **Task detail:** `.dev/_DONE/ai-debug-api/TASK-DETAIL.md` — ADA-P1-T05, ADA-P1-T06.
...
- `.dev/_DONE/ai-debug-api/reports/ADA-BATCH-04-REPORT.md` (DEV-GUIDE format): built, decisions/deviations,
