...
2. `.dev/_DONE/ai-debug-api/reviews/ADA-BATCH-08-REVIEW.md` (the finding + reproduce).
...
- `.dev/_DONE/ai-debug-api/reports/ADA-BATCH-09-REPORT.md` (DEV-GUIDE format): the chosen approach (sentinel vs
