...
- [x] **BSA-101** Mark `BlueprintBlackboard{1024,4096,16384}` `[DataPolicy(NoScenario)]` [details](./TASK-DETAIL.md#bsa-101-mark-blackboard-components-nosave) — *land with BSA-202*
