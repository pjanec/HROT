...
1. **Design Document:** `.dev/_DONE/blueprint-scenario/BLUEPRINT-SCENARIO-DESIGN.md` — §8 (action-node access)
2. **Task Details:** `.dev/_DONE/blueprint-scenario/TASK-DETAIL.md` — BSA-302 section
...
`.dev/_DONE/blueprint-scenario/reports/BATCH-05-REPORT.md`
