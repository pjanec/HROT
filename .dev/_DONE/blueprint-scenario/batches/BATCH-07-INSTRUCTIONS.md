...
1. **Design Document:** `.dev/_DONE/blueprint-scenario/BLUEPRINT-SCENARIO-DESIGN.md` — §12.2 (panel design), §12.3 (commit — two timings), §2 (authoring invariant), §5 (tier pre-provisioning)
2. **Task Details:** `.dev/_DONE/blueprint-scenario/TASK-DETAIL.md` — BSA-205 section
...
`.dev/_DONE/blueprint-scenario/reports/BATCH-07-REPORT.md`
