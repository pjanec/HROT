...
2. **Design Document:** `.dev/_DONE/blueprint-scenario/BLUEPRINT-SCENARIO-DESIGN.md` — §3 (unified seam), §10 (module placement)
3. **Task Details:** `.dev/_DONE/blueprint-scenario/TASK-DETAIL.md` — BSA-102 section
4. **Task Tracker:** `.dev/_DONE/blueprint-scenario/TASK-TRACKER.md`
...
`.dev/_DONE/blueprint-scenario/reports/BATCH-01-REPORT.md`

**If you have questions, create:**  
`.dev/_DONE/blueprint-scenario/questions/BATCH-01-QUESTIONS.md`
...
## 📚 Reference Materials
- **Design:** `.dev/_DONE/blueprint-scenario/BLUEPRINT-SCENARIO-DESIGN.md` — §3, §10
- **Task Details:** `.dev/_DONE/blueprint-scenario/TASK-DETAIL.md` — BSA-102
- **Task Tracker:** `.dev/_DONE/blueprint-scenario/TASK-TRACKER.md`
