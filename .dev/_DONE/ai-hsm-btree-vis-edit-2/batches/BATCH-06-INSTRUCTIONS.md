...
**Task:** TASK-BT-06 (`.dev/_DONE/ai-hsm-btree-vis-edit-2/TASK-DETAIL.md#task-bt-06--showcase-btree--starter-recipe`)
**Phase:** A · **One objective** (two coupled deliverables: a showcase asset + a Starter recipe).
**Decision D-03** (`.dev/_DONE/ai-hsm-btree-vis-edit-2/DECISIONS.md`): the Starter recipe is an **in-code** entry in `AvailableRecipes()` (no on-disk recipe discovery).
...
- Report → `.dev/_DONE/ai-hsm-btree-vis-edit-2/reports/BATCH-06-REPORT.md`.
