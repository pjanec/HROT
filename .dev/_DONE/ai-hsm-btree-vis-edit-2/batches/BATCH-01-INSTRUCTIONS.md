...
**Task:** TASK-BT-01 (see `.dev/_DONE/ai-hsm-btree-vis-edit-2/TASK-DETAIL.md#task-bt-01--live-actioncondition-palette`)
...
From `.dev/_DONE/ai-hsm-btree-vis-edit-2/TASK-TRACKER.md` "Working agreement":
...
- **Locked decisions you MUST follow:** `.dev/_DONE/ai-hsm-btree-vis-edit-2/DECISIONS.md` **D-01** (IsCondition discriminator) and **D-02** (encoded kind id). Do not deviate.
- Report → `.dev/_DONE/ai-hsm-btree-vis-edit-2/reports/BATCH-01-REPORT.md`. Questions (only if truly blocked) → `.dev/_DONE/ai-hsm-btree-vis-edit-2/questions/BATCH-01-QUESTIONS.md`.
