...
categorized (5 fixed, 5 Flaky, 74 Broken) in `.dev/_DONE/test-health/TEST-HEALTH.md`, with a reusable convention + filter.
...
with [Trait("Stability",...)] + inline reasons; full ledger in .dev/_DONE/test-health/TEST-HEALTH.md
