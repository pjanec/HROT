...
**Restate & obey the Working Agreement** in `.dev/_DONE/quick-reload/TASK-TRACKER.md` (one task; no cheating; finish without
...
- Build 0 warnings. Write `.dev/_DONE/quick-reload/reports/BATCH-QR-01-REPORT.md` (the overload, the delegation, the tests,
  build/test output).
