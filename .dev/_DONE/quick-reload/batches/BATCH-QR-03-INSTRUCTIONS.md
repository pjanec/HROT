...
**Restate & obey the Working Agreement** in `.dev/_DONE/quick-reload/TASK-TRACKER.md`. Touch ONLY `EditorSubsystem.cs`
...
- Write `.dev/_DONE/quick-reload/reports/BATCH-QR-03-REPORT.md` (the wiring, the emit calls, the verified namespaces, build/
