...
3. `.dev/_DONE/blueprint-finalize/reviews/BF-BATCH-SEQ1-REVIEW.md` — context on the SEQ1 IR + the debt this addresses.
...
- [ ] Report at `.dev/_DONE/blueprint-finalize/reports/BF-BATCH-SEQ2-LATENTEMIT-REPORT.md`, every section filled.
