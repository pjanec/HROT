...
2. `.dev/_DONE/blueprint-finalize/reviews/BATCH-BB1A-REVIEW.md` — **fix Issue 1 first** (Corrective Task 0 below).
...
4. `.dev/_DONE/blueprint-finalize/reports/SE1-REPORT.md` — how `InspectorWindow` drives the StructEdit
