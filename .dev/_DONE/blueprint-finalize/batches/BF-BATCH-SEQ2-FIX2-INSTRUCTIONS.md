...
- **`.dev/_DONE/blueprint-finalize/reports/BF-BATCH-DIAGFAIL-REBUILD-REPORT.md`:** you rewrote this **committed** report.
  Restore it: `git checkout HEAD -- .dev/_DONE/blueprint-finalize/reports/BF-BATCH-DIAGFAIL-REBUILD-REPORT.md`.
- **Duplicate script:** you added `.dev/_DONE/blueprint-finalize/verify-rebuildrefresh.ps1` — the committed repro is
  `BF-REBUILDREFRESH-REPRO.ps1`. Delete the duplicate unless it adds something the committed one lacks (then explain).
- Write the report at the CORRECT path this time: `.dev/_DONE/blueprint-finalize/reports/BF-BATCH-SEQ2-FIX-REPORT.md`
