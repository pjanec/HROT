...
**Restate & obey the Working Agreement** in `.dev/_DONE/toolbar-debug-activate/TASK-TRACKER.md` (one task; no cheating;
...
- Write `.dev/_DONE/toolbar-debug-activate/reports/BATCH-TDA-02-REPORT.md` (the diffs, verified type shapes/member names,
