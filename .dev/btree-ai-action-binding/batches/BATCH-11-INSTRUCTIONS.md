...
2. `.dev/btree-ai-action-binding/LIVE-VALUE-DISPLAY-DESIGN.md` — Feature B section + the LOCKED decisions (selected-entity scope; do NOT build the "any entity" / canvas-overlay tier).
...
- [ ] Report at `.dev/btree-ai-action-binding/reports/BATCH-11-REPORT.md`.
