...
3. `.dev/btree-ai-action-binding/SLICE1-DESIGN.md` §2 (ground truth), §3.2, §3.3.
4. `.dev/btree-ai-action-binding/TASK-DETAIL.md` §S1-2, §S1-3, §S1-4 — **the exact named test specs + assertions you must implement. Do NOT invent acceptance criteria.**
5. `.dev/btree-ai-action-binding/reviews/BATCH-01-REVIEW.md` — context (no corrective tasks).
...
## Report Requirements (`.dev/btree-ai-action-binding/reports/BATCH-02-REPORT.md`)
