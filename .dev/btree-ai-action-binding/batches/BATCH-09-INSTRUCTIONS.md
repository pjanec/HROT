...
2. `.dev/btree-ai-action-binding/TASK-DETAIL.md` §S2-G — the gate + named proof tests + exact assertions.
3. `.dev/btree-ai-action-binding/SLICE2-DESIGN.md` §5 (demos).
...
- [ ] Report at `.dev/btree-ai-action-binding/reports/BATCH-09-REPORT.md`.
