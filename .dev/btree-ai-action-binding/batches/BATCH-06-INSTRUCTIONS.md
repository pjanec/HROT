...
2. `.dev/btree-ai-action-binding/SLICE2-DESIGN.md` §2, §3, §6.2, §9, §10 (Flaw 1) — the spec. **§10 is authoritative where it conflicts with §9.**
3. `.dev/btree-ai-action-binding/TASK-DETAIL.md` §S2-1, §S2-2 — the exact named tests + assertions. **Implement those tests with those assertions; do not invent acceptance criteria.**
...
- [ ] Report written to `.dev/btree-ai-action-binding/reports/BATCH-06-REPORT.md`.
