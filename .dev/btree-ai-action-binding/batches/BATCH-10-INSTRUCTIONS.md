...
2. `.dev/btree-ai-action-binding/LIVE-VALUE-DISPLAY-DESIGN.md` — the design (PREREQ + Feature A; Feature B is NOT in this batch).
...
- [ ] Report at `.dev/btree-ai-action-binding/reports/BATCH-10-REPORT.md`.
