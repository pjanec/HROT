...
2. `.dev/btree-ai-action-binding/SLICE2-DESIGN.md` §10 Flaw 3 (the mandated fix) + §6.2.
3. `.dev/btree-ai-action-binding/TASK-DETAIL.md` §S2-4 — the two named tests + exact assertions. Implement those exactly; do not invent acceptance criteria.
...
- [ ] Report at `.dev/btree-ai-action-binding/reports/BATCH-07-REPORT.md`.
