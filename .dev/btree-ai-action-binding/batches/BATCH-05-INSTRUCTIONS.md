...
3. `.dev/btree-ai-action-binding/SLICE1-DESIGN.md` §5 (demo specs).
4. `.dev/btree-ai-action-binding/TASK-DETAIL.md` §S1-G — the gate's named proof tests + assertions. **Implement exactly; do not invent acceptance criteria.**
5. `.dev/btree-ai-action-binding/DEBT-TRACKER.md` — DEBT-AIB-009 (hardcoded-DTO panel wiring) and DEBT-AIB-012 (inspector multi-DTO read) are folded into this batch.
...
## Report Requirements (`.dev/btree-ai-action-binding/reports/BATCH-05-REPORT.md`)
