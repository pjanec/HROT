...
3. `.dev/btree-ai-action-binding/TASK-DETAIL.md` §S1-0 and §S1-1 — the exact success conditions / named test specs you must implement. **Implement those tests with those assertions exactly; do not invent your own acceptance criteria.**
4. `.dev/btree-ai-action-binding/SLICE1-DESIGN.md` §3.1, §9 (Q6).
...
## Report Requirements (`.dev/btree-ai-action-binding/reports/BATCH-01-REPORT.md`)
