...
**Task:** TASK-BT-03 (`.dev/ai-hsm-btree-vis-edit-2/TASK-DETAIL.md#task-bt-03--pill-glyph--param-label`)
**Phase:** A · **One objective only.**

## 🔒 Working agreement (MANDATORY)
Same as prior batches (`.dev/ai-hsm-btree-vis-edit-2/TASK-TRACKER.md`): one task; **NO cheating** (no excluding files / suppressing diagnostics / weakening tests); **finish without asking** until build clean + `Failed: 0`; tests assert real values; litter-free; report = diffs.
...
- Report → `.dev/ai-hsm-btree-vis-edit-2/reports/BATCH-03-REPORT.md`.
