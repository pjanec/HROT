...
**Task:** TASK-BT-10 (REVIEW-BT F3). **One objective.** Decision **D-06** (`.dev/ai-hsm-btree-vis-edit-2/DECISIONS.md`).
...
## 📋 Onboarding / context
- Report → `.dev/ai-hsm-btree-vis-edit-2/reports/BATCH-10-REPORT.md`.
