...
**Task:** TASK-BT-04 (`.dev/ai-hsm-btree-vis-edit-2/TASK-DETAIL.md#task-bt-04--validators--diagnostics-window`)
...
- Report → `.dev/ai-hsm-btree-vis-edit-2/reports/BATCH-04-REPORT.md`.
