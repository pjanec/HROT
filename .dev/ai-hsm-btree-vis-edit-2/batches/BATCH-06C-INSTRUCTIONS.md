...
**Task:** TASK-BT-06 corrective. **One objective.** See decision **D-05** in `.dev/ai-hsm-btree-vis-edit-2/DECISIONS.md` and **VE-DEBT-002**.
...
- [ ] Update `.dev/ai-hsm-btree-vis-edit-2/reports/BATCH-06-REPORT.md` (note the two correctives + that real-condition binding is deferred to VE-DEBT-002).
