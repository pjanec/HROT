...
**Task:** TASK-BT-05 (`.dev/ai-hsm-btree-vis-edit-2/TASK-DETAIL.md#task-bt-05--validation-inline-on-canvas`)
**Phase:** A · **One objective only.** Depends on BT-04 (validator).
**Scope decision D-04** (`.dev/ai-hsm-btree-vis-edit-2/DECISIONS.md`): this batch covers the **canvas node-state** only. The inspector banner is DEFERRED — do NOT implement it here.
...
- Report → `.dev/ai-hsm-btree-vis-edit-2/reports/BATCH-05-REPORT.md`.
