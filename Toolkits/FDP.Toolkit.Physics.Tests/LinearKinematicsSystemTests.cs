...
{
    /// <summary>
    /// Unit tests for <see cref="LinearKinematicsSystem"/> (DEBT-032).
    ...
    public class LinearKinematicsSystemTests : IDisposable
    {
        ...
        /// Linear=(10,0,0): after one tick at dt=1.0f the position must be (10,0,0).
        /// </summary>
        [Fact]
        ...
        /// This is the key exclusion test: proves <c>Without&lt;VehicleState&gt;()</c> works
        /// and bullets will not compete with vehicles.
        /// </summary>
        [Fact]
        ...
        /// <summary>
        /// Entity with only <see cref="SimTransform"/> (static building — no
        /// <see cref="SimVelocity"/>) must not be touched by the system.
        /// </summary>
        [Fact]
