...
public sealed class ClusterSlaveTests
{
    ...
    public void FaultedPrepare_ClearsPendingQueue()
    {
        ...
        {
            TransactionId = txId, TargetNodeId = 0,
            Operation     = NodeOpType.CommitState, DomainPayload = targetState,
        });
