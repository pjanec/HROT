...
namespace Fdp.Toolkit.Behavior.TacticalOrderMapper
{
    ...
    /// to a concrete <see cref="AssignDoctrineEvent"/> for a specific entity.
    ///
    /// <para>
    ...
    /// needed to select the correct doctrine and format its DTO.  Stateful
    ...
    public interface ITacticalOrderMapper
    {
        ...
        /// <summary>
        /// Attempts to translate the intent into a concrete doctrine assignment.
        /// </summary>
        ...
        /// <see cref="AssignDoctrineEvent"/> ready for publication.  Undefined
