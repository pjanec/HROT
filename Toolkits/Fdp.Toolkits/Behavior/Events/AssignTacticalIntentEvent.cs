...
namespace Fdp.Toolkit.Behavior.Events
{
    ...
    public sealed class AssignTacticalIntentEvent
    {
        ...
        /// <c>ITacticalOrderMapper</c>, or treated as a direct doctrine name
        ...
        /// <see cref="AssignDoctrineEvent.JsonParams"/> on the fallback path.
