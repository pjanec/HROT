...
public class SpawnMovingVehicleIntegrationTests
{
    ...
    public void SpawnMovingVehicle_IgPositionContinuesToUpdate()
    {
        ...
        long tkbType  = TkbEntityTypes.Tank_M1Abrams;
        var  spawnGeo = new GeoPosition { Latitude = 52.521, Longitude = 13.407, Altitude = 0 };
    ...
    /// </summary>
    private static long FindFirstMovingCandidateNetworkId(BagiraRunnerHarness harness)
    {
