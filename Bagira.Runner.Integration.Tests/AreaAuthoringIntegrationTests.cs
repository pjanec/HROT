...
public class AreaAuthoringIntegrationTests
{
    ...
    private static bool SimHostHasPolyline(BagiraRunnerHarness harness, long networkId)
    {
    ...
    private static bool IgHasPolyline(BagiraRunnerHarness harness, long networkId)
    {
    ...
    private static bool IgHasStyle(BagiraRunnerHarness harness, long networkId)
    {
        var entityMap = harness.Ig.App.TestHook_EntityMap;
        if (!entityMap.TryGetEntity(networkId, out var entity)) return false;
        var world = harness.Ig.App.World;
    ...
    private static MapOverlayStyle GetIgStyle(BagiraRunnerHarness harness, long networkId)
    {
        var entityMap = harness.Ig.App.TestHook_EntityMap;
    ...
    private static IReadOnlyList<Vector2> GetIgPolylinePoints(BagiraRunnerHarness harness, long networkId)
    {
        var entityMap = harness.Ig.App.TestHook_EntityMap;
        if (!entityMap.TryGetEntity(networkId, out var entity))
