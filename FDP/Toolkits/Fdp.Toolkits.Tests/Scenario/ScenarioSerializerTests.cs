...
namespace Fdp.Toolkit.Scenario.Tests
{
    ...
    public sealed class ScenarioSerializerTests : IDisposable
    {
        ...
        // ── SerializeEntity_HeaderNativeTranslator_AlwaysRuns ─────────────────────
        ...
        public void SerializeEntity_HeaderNativeTranslator_AlwaysRuns()
        {
            ...
            // Use the saveable mask — it has no bits that match an empty consumed mask,
        ...
        /// must still be skipped — the fix must not break the strict mask gate for
        ...
        public void SerializeEntity_ComponentBoundTranslator_SkippedWhenMaskDoesNotIntersect()
        {
            ...
            // An empty mask has no bits set — it cannot intersect any non-empty consumed mask.
    ...
    /// non-empty mask (bit 291 — a free test component ID).  <c>CanTranslate</c>
    ...
    {
        // Use component ID 291 — declared free in TestComponents.cs comment block.
