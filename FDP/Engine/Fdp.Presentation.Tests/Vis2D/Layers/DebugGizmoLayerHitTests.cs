...
namespace Fdp.Toolkit.Vis2D.Tests.Layers
{
    public class DebugGizmoLayerHitTests
    {
        ...
        public void SC_GZ026_1_LineMidpoint_IsHit()
        {
            ...
            bool hit = layer.HandleInput(new Vector2(50f, 0f), MapMouseButton.Left, isPressed: true);
        ...
        public void SC_GZ026_2_BeyondEndpoint_IsMiss()
        {
            ...
            bool hit = layer.HandleInput(new Vector2(110f, 0f), MapMouseButton.Left, isPressed: true);
        ...
        public void SC_GZ026_3_SphereCenter_IsHit()
        {
            ...
            bool hit = layer.HandleInput(new Vector2(20f, 30f), MapMouseButton.Left, isPressed: true);
        ...
        public void SC_GZ026_4_ScreenPixels_ZoomScalesHitRadius()
        {
            ...
            bool hit2 = layer.HandleInput(new Vector2(50f, 2f), MapMouseButton.Left, isPressed: true);
            Assert.True(hit2);
            ...
            bool miss4 = layer2.HandleInput(new Vector2(50f, 4f), MapMouseButton.Left, isPressed: true);
            Assert.False(miss4);
        }
    }
}
