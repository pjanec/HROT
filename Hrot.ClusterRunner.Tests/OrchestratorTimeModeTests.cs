...
{
    // Domain 15 is reserved for all orchestrator tests (shared with ClusterMasterBootstrapTests
    // via the same xunit.runner.json serial constraint on the Hrot.Orchestrator.Tests assembly;
    ...
    public void PendingTimeMode_Deterministic_PublishesSwitchTimeModeEvent()
    {
        ...
        Assert.True(captured.HasValue,
            ...
            "after ClusterMaster.PendingTimeMode was set to 'Deterministic'.");
