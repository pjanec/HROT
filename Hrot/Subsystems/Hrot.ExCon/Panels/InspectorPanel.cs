...
///
/// <para><b>ExCon-DEBT-029:</b> <see cref="IDerEntity.GetAllDescriptorTypes"/>
...
public sealed class InspectorPanel
{
    ...
    /// <summary>
    /// Called by <see cref="ExConMock.Update"/> whenever the selected entity
    ...
    public static List<InspectorLine> BuildDescriptorLines(IDerEntity entity)
    {
        ...
        {
            // ExCon-DEBT-029: guard via HasDescriptor before calling GetDescriptor.
