...
{
    /// <summary>
    /// Stable compile-time integer constants for the CGF Brain-tier behaviors.
    ///
    /// These are passed to <see cref="Fdp.Toolkit.Behavior.BehaviorRegistry.Register"/> at
    /// application startup and stored in
    /// <see cref="Fdp.Toolkit.Behavior.Components.BehaviorState.ActiveBehaviorHash"/>.
    ///
    /// <b>Range:</b> 3001-3099 (navigation and wander behaviours).
    /// Values must be globally unique and must never change once published.
    ///
    /// See <see cref="Fdp.Toolkit.Behavior.BehaviorIds"/> for framework-level behavior IDs.
    /// </summary>
    public static class CgfBehaviorIds
    {
        ...
        // ── Combat behaviors (BTree, 3012-3019) ───────────────────────────────
