...
{
    /// <summary>
    /// Unit tests for <see cref="CgfDoctrineSetup"/> factory methods — TASK-C011.
    /// </summary>
    public sealed class CgfDoctrineSetupTests
    {
        // ── C011 SC1: CreateBehaviorRemapper remaps FireAtTarget JSON ─────────

        /// <summary>
        /// C011 SC1: <see cref="CgfDoctrineSetup.CreateBehaviorRemapper"/> returns
        ...
        {
            var remapper = CgfDoctrineSetup.CreateBehaviorRemapper();
        ...
        /// <summary>
        /// C011 SC2: <see cref="CgfDoctrineSetup.CreateBehaviorRemapper"/> returns
