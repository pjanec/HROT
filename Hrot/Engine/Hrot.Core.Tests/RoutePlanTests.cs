...
public class RoutePlanTests
{
    ...
    {
        Assert.True(IsBlittable<Hrot.Map.Common.Events.CmdAppendPersonalWaypoint>(),
    ...
    public void CmdAppendPersonalWaypoint_FieldsRoundTrip_Intact()
    {
        ...
        var cmd = new Hrot.Map.Common.Events.CmdAppendPersonalWaypoint
        {
    ...
    public void RoutePlan_ComponentId_Is220()
    {
        ...
        Assert.NotNull(attr);
        Assert.Equal(HrotComponentIds.RoutePlan, attr!.Id);
    }
    ...
    public void PersonalRouteRef_ComponentId_Is221()
    {
        ...
        Assert.NotNull(attr);
        Assert.Equal(HrotComponentIds.PersonalRouteRef, attr!.Id);
    }
    ...
    public void RouteTrajectoryCache_ComponentId_Is222()
    {
        ...
        Assert.NotNull(attr);
        Assert.Equal(HrotComponentIds.RouteTrajectoryCache, attr!.Id);
    }
