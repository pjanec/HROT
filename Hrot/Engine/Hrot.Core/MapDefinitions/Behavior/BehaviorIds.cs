...
{
    /// <summary>
    /// Compile-time integer IDs for all behavior parameter DTOs defined in this assembly.
    /// Values mirror <c>Hrot.CGF.Configuration.CgfBehaviorIds</c> and must stay in sync.
    /// Range 3001-3099 is reserved for CGF behaviors.
    /// </summary>
    internal static class BehaviorIds
    {
