...
[ImGuiRenderer(typeof(BlueprintBlackboard4096))]
public sealed class BlueprintBlackboard4096Renderer : IEntityAwareImGuiRenderer
{
    ...
    // ---- IImGuiRenderer ----
    public string? GetSummary(object value) => "Instance Blueprints (4096 bytes)";
    ...
    public string? GetSummary(IInspectableSession session, Entity entity, object value)
    {
        ...
        if (registry == null || value is not BlueprintBlackboard4096 bb)
    ...
    public bool RenderValue(IInspectableSession session, Entity entity, object value, out string? doubleClickedPath)
    {
        ...
        unsafe
        {
            ...
            if (ImGui.BeginTable("##bp4096", 4, ImGuiTableFlags.Borders | ImGuiTableFlags.RowBg))
            {
