...
public sealed class ClusterTimeControlStatusBarSection
{
    ...
    public void Render()
    {
        ...
        if (DrawTransportButton("##tc_pp", iconSize, showPlay ? BtnShape.Play : BtnShape.Pause,
        ...
        if (DrawTransportButton("##tc_step", iconSize, BtnShape.Step, enabled: _facade.IsStepEnabled)
        ...
        if (DrawTransportButton("##tc_stop", iconSize, BtnShape.Stop, enabled: _facade.IsStopEnabled)
        ...
        var ts = TimeSpan.FromSeconds(_facade.TotalTime);
