...
namespace Hrot.ClusterRunner.Integration.Tests
{
    ...
    /// </summary>
    public unsafe class HsmDoctrineIntegrationTests
    {
        // -- helpers -------------------------------------------------------
        ...
        // DoctrineFinishedEvent is published (Frame 2).
        [Fact]
        public void E2_FullFrame_MobilityLostInterrupt_ThenDoctrineFinished()
        {
            ...
            registry.Register(docId, "E2Patrol",
                new DoctrineDefinition { Name = "E2Patrol", BrainTier = BehaviorConstants.BrainTierHsm, HsmDefinition = blob });
            ...
            // Assert: DoctrineFinishedEvent published for this entity.
            int count = 0;
