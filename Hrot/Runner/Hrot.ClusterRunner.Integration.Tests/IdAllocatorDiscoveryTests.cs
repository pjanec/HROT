...
/// discovery handshake works correctly when all three subsystems (SimHost, IG, ExCon) are
/// started together via <see cref="HrotRunnerHarness"/>.
///
/// <para>
...
public class IdAllocatorDiscoveryTests
{
    ...
    /// <see cref="HrotRunnerHarness"/> initialises SimHost — even though the DDS
