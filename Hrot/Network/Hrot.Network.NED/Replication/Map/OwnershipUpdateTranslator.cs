    ...
    public sealed class OwnershipUpdateTranslator : IDescriptorTranslator
    {
        ...
        public void ScanAndPublish(ISimulationView view)
        {
            ...
            foreach (var evt in updates)
            {
                ...
                var (typeId, instanceId) = Fdp.ModuleHost.Core.Network.OwnershipExtensions.UnpackKey(evt.PackedKey);
        ...
        public void PollIngress(IEntityCommandBuffer cmd, ISimulationView view)
        {
            ...
            foreach (var sample in loan)
            {
                ...
                long packedKey = Fdp.ModuleHost.Core.Network.OwnershipExtensions.PackKey(msg.DescrTypeId, msg.InstanceId);
