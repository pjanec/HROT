...
- ID correctly moved from `GlobalComponentIds` (119, freed with tombstone comment) to `BagiraComponentIds` (167).
...
- `BagiraComponentIds_NoDuplicates` and `BagiraComponentIds_AllInApplicationRange` tests confirm the uniqueness contract is maintained.
