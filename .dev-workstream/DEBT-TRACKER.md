...
- **DEBT-035 (P1):** DoctrineIngressSystem catch ordering bug — fixed as Corrective-0 in BATCH-14.
...
- **All open debt items now resolved.** DEBT-027 is the only partial item remaining (low priority, LOS pipeline rework).
