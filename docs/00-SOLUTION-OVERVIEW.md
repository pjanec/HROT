...
- [Fdp.Core](projects/FDP/Core/Fdp.Core.md)
- [Fdp.ModuleHost](projects/FDP/Core/Fdp.ModuleHost.md)
- [Fdp.Presentation](projects/FDP/Core/Fdp.Presentation.md)
- [Fdp.Diagnostics.Contracts](projects/FDP/Core/Fdp.Diagnostics.Contracts.md)
- [Fdp.Diagnostics.Network](projects/FDP/Core/Fdp.Diagnostics.Network.md)
- [Fdp.Network.Cyclone](projects/FDP/Network/Fdp.Network.Cyclone.md)
- [Fdp.Toolkits](projects/FDP/Toolkits/Fdp.Toolkits.md)
- [Fdp.Toolkits.Analyzers](projects/FDP/Toolkits/Fdp.Toolkits.Analyzers.md)
- [Tkb.SourceGen](projects/FDP/Toolkits/Tkb.SourceGen.md)
- [Fdp.Tools.RecordingDumper](projects/FDP/Tools/Fdp.Tools.RecordingDumper.md)
- [FDP Core Framework (relationships)](projects/relationships/FDP-Core-Framework.md)
- [FDP Network Stack (relationships)](projects/relationships/FDP-Network-Stack.md)
...
| ECS components owned | `BehaviorState`, `BrainInterrupts`, `MissionPlan`, `TargetMemory` | `SimTransform`, `WorldPos`, `NavigationStatus`, `PhysicsState` |
...
**Engine layer:**
- [Hrot.Core](projects/Hrot/Engine/Hrot.Core.md)
- [Hrot.Common](projects/Hrot/Engine/Hrot.Common.md)
- [Hrot.Presentation](projects/Hrot/Engine/Hrot.Presentation.md)
- [Hrot.UI.Common](projects/Hrot/Engine/Hrot.UI.Common.md)

**Network layer:**
- [Hrot.Network.NED](projects/Hrot/Network/Hrot.Network.NED.md)
- [Hrot.Network.BDC](projects/Hrot/Network/Hrot.Network.BDC.md)
- [Hrot.Network.Orchestration](projects/Hrot/Network/Hrot.Network.Orchestration.md)
...
- [Hrot.SimHost](projects/Hrot/Subsystems/Hrot.SimHost.md)
- [Hrot.CGF](projects/Hrot/Subsystems/Hrot.CGF.md)
- [Hrot.IG](projects/Hrot/Subsystems/Hrot.IG.md)
- [Hrot.ExCon](projects/Hrot/Subsystems/Hrot.ExCon.md)
...
- [Hrot.Blueprints.Compiler](projects/Hrot/Blueprints/Hrot.Blueprints.Compiler.md)
- [Hrot.Blueprints.Editor](projects/Hrot/Blueprints/Hrot.Blueprints.Editor.md)
- [Hrot.Blueprints.Generators](projects/Hrot/Blueprints/Hrot.Blueprints.Generators.md)

**AI Editors:**
- [Hrot.BTree.Editor](projects/Hrot/AI/Hrot.BTree.Editor.md)
- [Hrot.Hsm.Editor](projects/Hrot/AI/Hrot.Hsm.Editor.md)
- [Hrot.Editor.AiShared](projects/Hrot/Editor/Hrot.Editor.AiShared.md)

**Relationship docs:**
- [Hrot Simulation Pipeline](projects/relationships/Hrot-Simulation-Pipeline.md)
- [AI Behavior Authoring](projects/relationships/AI-Behavior-Authoring.md)
- [Blueprint Scripting System](projects/relationships/Blueprint-Scripting-System.md)
...
See [FDP Network Stack](projects/relationships/FDP-Network-Stack.md) for the full
...
See [FDP Core Framework](projects/relationships/FDP-Core-Framework.md) for the full
ECS layering model.
...
See [AI Behavior Authoring](projects/relationships/AI-Behavior-Authoring.md).
...
See [Blueprint Scripting System](projects/relationships/Blueprint-Scripting-System.md).
...
3. Use the `Hrot.BTree.Editor` canvas to compose the tree visually, or write it using
   ...
   is a build-time-only key for `Marshal.OffsetOf`; the compiled tree ticks against the root params
   occurrence slot regardless of what you name it here).
...
See [AI Behavior Authoring](projects/relationships/AI-Behavior-Authoring.md) and
[Hrot.AI.Behaviors](projects/Hrot/Subsystems/Hrot.AI.Behaviors.md).
...
|---------|----------|-------------|-----|
| `Fdp.Core` | Engine / ECS | ECS kernel: entities, components, queries, event bus, flight recorder, time | [link](projects/FDP/Core/Fdp.Core.md) |
| `Fdp.Core.Benchmarks` | Benchmark | Micro-benchmarks for Fdp.Core hot paths | -- |
| `Fdp.Core.Tests` | Test | Unit tests for Fdp.Core | -- |
| `Fdp.ModuleHost` | Engine / Orchestration | Module lifecycle, scheduling, RCU hot-plug, snapshot isolation | [link](projects/FDP/Core/Fdp.ModuleHost.md) |
...
| `Fdp.Presentation` | Engine / UI | Raylib app host, 2D map canvas, ImGui panels, window manager | [link](projects/FDP/Core/Fdp.Presentation.md) |
...
| Project | Category | Description | Doc |
|---------|----------|-------------|-----|
| `Fdp.Diagnostics.Contracts` | Diagnostics | `IDebugDrawBuilder`, zero-alloc gizmo emission contracts | [link](projects/FDP/Core/Fdp.Diagnostics.Contracts.md) |
| `Fdp.Diagnostics.Contracts.Tests` | Test | Tests for Diagnostics.Contracts | -- |
| `Fdp.Diagnostics.Network` | Diagnostics / Network | CycloneDDS adapter for gizmo DDS channel | [link](projects/FDP/Core/Fdp.Diagnostics.Network.md) |

### 9.3 FDP Network

| Project | Category | Description | Doc |
|---------|----------|-------------|-----|
| `Fdp.Network.Cyclone` | Network | CycloneDDS ECS adapter, ingress/egress systems, distributed ID allocator | [link](projects/FDP/Network/Fdp.Network.Cyclone.md) |
...
| Project | Category | Description | Doc |
|---------|----------|-------------|-----|
| `Fdp.Toolkits` | Toolkit | 19-domain simulation toolkit (Behavior, Combat, CarKinem, DER, Geographic, Navigation, Perception, Replay, Scenario, Time, Tkb, ...) | [link](projects/FDP/Toolkits/Fdp.Toolkits.md) |
| `Fdp.Toolkits.Analyzers` | Build / Roslyn | Roslyn analyzers and source generators (BTree/HSM/Gizmo dispatch, `FDP_001`) | [link](projects/FDP/Toolkits/Fdp.Toolkits.Analyzers.md) |
| `Fdp.Toolkit.Tkb.SourceGen` | Build / Roslyn | Source gen: auto-registers `[TkbDescriptor]` DTOs | [link](projects/FDP/Toolkits/Tkb.SourceGen.md) |
...
| Project | Category | Description | Doc |
|---------|----------|-------------|-----|
| `Fdp.Tools.RecordingDumper` | Tool (CLI) | Converts `.fdp` binary recordings to JSON | [link](projects/FDP/Tools/Fdp.Tools.RecordingDumper.md) |

### 9.7 HROT Engine Layer

| Project | Category | Description | Doc |
|---------|----------|-------------|-----|
| `Hrot.Core` | Engine | Domain vocabulary, network abstractions, node config, dead reckoning | [link](projects/Hrot/Engine/Hrot.Core.md) |
| `Hrot.Common` | Engine | Node bootstrap, gizmo library, mission control execution, unit hierarchy | [link](projects/Hrot/Engine/Hrot.Common.md) |
| `Hrot.Presentation` | Engine / UI | HROT renderers, behavior-parameter UI, scenario editor module | [link](projects/Hrot/Engine/Hrot.Presentation.md) |
| `Hrot.UI.Common` | Engine / UI | Hexagonal-architecture UI facades, shared ImGui panels | [link](projects/Hrot/Engine/Hrot.UI.Common.md) |

### 9.8 HROT Network Layer

| Project | Category | Description | Doc |
|---------|----------|-------------|-----|
| `Hrot.Network.NED` | Network | Full NED protocol (30+ DDS topics) -- production inter-node communication | [link](projects/Hrot/Network/Hrot.Network.NED.md) |
| `Hrot.Network.BDC` | Network | Lightweight BDC protocol (2 DDS topics) -- federation / IG tracking | [link](projects/Hrot/Network/Hrot.Network.BDC.md) |
| `Hrot.Network.Orchestration` | Network | Cluster 2PC protocol, orchestration DDS topics (7) | [link](projects/Hrot/Network/Hrot.Network.Orchestration.md) |
...
| Project | Category | Description | Doc |
|---------|----------|-------------|-----|
| `Hrot.Blueprints.Core` | Blueprints | Runtime assembly: asset model, 8-stage compiler pipeline, debug infrastructure | [link](projects/Hrot/Blueprints/Hrot.Blueprints.Core.md) |
| `Hrot.Blueprints.Compiler` | Blueprints | AOT compiler: 7-stage pipeline (Parse through Emit), `netstandard2.0` | [link](projects/Hrot/Blueprints/Hrot.Blueprints.Compiler.md) |
| `Hrot.Blueprints.Editor` | Blueprints / UI | ImGui graph editor, inspector, hot-reload, debug session | [link](projects/Hrot/Blueprints/Hrot.Blueprints.Editor.md) |
| `Hrot.Blueprints.Generators` | Blueprints / Build | Roslyn `IIncrementalGenerator` for `.bp.json` -> `.g.cs` at MSBuild time | [link](projects/Hrot/Blueprints/Hrot.Blueprints.Generators.md) |

### 9.12 HROT AI Editors

| Project | Category | Description | Doc |
|---------|----------|-------------|-----|
| `Hrot.BTree.Editor` | AI Editor | Visual BTree authoring: NodeEdit canvas, fluent emitter, live debug overlay | [link](projects/Hrot/AI/Hrot.BTree.Editor.md) |
| `Hrot.Hsm.Editor` | AI Editor | Visual HSM authoring: states, transitions, orthogonal regions, debug overlay | [link](projects/Hrot/AI/Hrot.Hsm.Editor.md) |
| `Hrot.Editor.AiShared` | AI Editor | Shared infra: catalog, selection, references, refactoring, hot-reload, debug sessions | [link](projects/Hrot/Editor/Hrot.Editor.AiShared.md) |
...
All generated documentation lives under `docs/projects/`.

### 12.1 Relationship Documents

| Document | Covers |
|----------|--------|
| [FDP Core Framework](projects/relationships/FDP-Core-Framework.md) | Fdp.Core + Fdp.ModuleHost + Fdp.Presentation + Fdp.Diagnostics.Contracts as a unified framework |
| [Hrot Simulation Pipeline](projects/relationships/Hrot-Simulation-Pipeline.md) | Full IOS/IG/SimHost distributed pipeline with Brain/Muscle split |
| [FDP Network Stack](projects/relationships/FDP-Network-Stack.md) | All network layers from CycloneDDS up through NED/BDC/Orchestration |
| [AI Behavior Authoring](projects/relationships/AI-Behavior-Authoring.md) | BTree/HSM authoring pipeline from editor to runtime execution |
| [Blueprint Scripting System](projects/relationships/Blueprint-Scripting-System.md) | Full Blueprint compiler/editor/generator/runtime stack |

### 12.2 FDP Project Documents

| Document | Project |
|----------|---------|
| [Fdp.Core](projects/FDP/Core/Fdp.Core.md) | ECS kernel |
| [Fdp.ModuleHost](projects/FDP/Core/Fdp.ModuleHost.md) | Module orchestration |
| [Fdp.Presentation](projects/FDP/Core/Fdp.Presentation.md) | Raylib/ImGui visual runtime |
| [Fdp.Diagnostics.Contracts](projects/FDP/Core/Fdp.Diagnostics.Contracts.md) | Debug draw contracts |
| [Fdp.Diagnostics.Network](projects/FDP/Core/Fdp.Diagnostics.Network.md) | Gizmo DDS channel |
| [Fdp.Network.Cyclone](projects/FDP/Network/Fdp.Network.Cyclone.md) | CycloneDDS adapter |
| [Fdp.Toolkits](projects/FDP/Toolkits/Fdp.Toolkits.md) | 19-domain simulation toolkit |
| [Fdp.Toolkits.Analyzers](projects/FDP/Toolkits/Fdp.Toolkits.Analyzers.md) | Roslyn analyzers and generators |
| [Tkb.SourceGen](projects/FDP/Toolkits/Tkb.SourceGen.md) | TKB descriptor source generator |
| [Fdp.Tools.RecordingDumper](projects/FDP/Tools/Fdp.Tools.RecordingDumper.md) | Recording to JSON CLI tool |

### 12.3 HROT Engine Documents

| Document | Project |
|----------|---------|
| [Hrot.Core](projects/Hrot/Engine/Hrot.Core.md) | HROT domain kernel |
| [Hrot.Common](projects/Hrot/Engine/Hrot.Common.md) | Shared foundation (bootstrap, gizmos, missions) |
| [Hrot.Presentation](projects/Hrot/Engine/Hrot.Presentation.md) | HROT engine-level presentation |
| [Hrot.UI.Common](projects/Hrot/Engine/Hrot.UI.Common.md) | Hexagonal UI facades and panels |

### 12.4 HROT Network Documents

| Document | Project |
|----------|---------|
| [Hrot.Network.NED](projects/Hrot/Network/Hrot.Network.NED.md) | Full NED protocol |
| [Hrot.Network.BDC](projects/Hrot/Network/Hrot.Network.BDC.md) | Lightweight BDC protocol |
| [Hrot.Network.Orchestration](projects/Hrot/Network/Hrot.Network.Orchestration.md) | Cluster orchestration protocol |
...
| Document | Project |
|----------|---------|
| [Hrot.Orchestrator](projects/Hrot/Subsystems/Hrot.Orchestrator.md) | Cluster orchestrator |
| [Hrot.SimHost](projects/Hrot/Subsystems/Hrot.SimHost.md) | Authoritative simulation (Muscle) |
| [Hrot.CGF](projects/Hrot/Subsystems/Hrot.CGF.md) | Computer-generated forces (Brain) |
| [Hrot.IG](projects/Hrot/Subsystems/Hrot.IG.md) | Image generator |
| [Hrot.ExCon](projects/Hrot/Subsystems/Hrot.ExCon.md) | Exercise control station |
...
| Document | Project |
|----------|---------|
| [Hrot.Blueprints.Core](projects/Hrot/Blueprints/Hrot.Blueprints.Core.md) | Blueprint runtime and compiler core |
| [Hrot.Blueprints.Compiler](projects/Hrot/Blueprints/Hrot.Blueprints.Compiler.md) | Blueprint AOT compiler |
| [Hrot.Blueprints.Editor](projects/Hrot/Blueprints/Hrot.Blueprints.Editor.md) | Blueprint visual editor |
| [Hrot.Blueprints.Generators](projects/Hrot/Blueprints/Hrot.Blueprints.Generators.md) | Blueprint Roslyn source generator |

### 12.8 HROT AI Editor Documents

| Document | Project |
|----------|---------|
| [Hrot.BTree.Editor](projects/Hrot/AI/Hrot.BTree.Editor.md) | Visual BTree editor |
| [Hrot.Hsm.Editor](projects/Hrot/AI/Hrot.Hsm.Editor.md) | Visual HSM editor |
| [Hrot.Editor.AiShared](projects/Hrot/Editor/Hrot.Editor.AiShared.md) | Shared AI editor infrastructure |
