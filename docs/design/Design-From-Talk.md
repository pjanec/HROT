...
Keep on mind the design talk is not always absolutely precise in regards to current sources. You need to review
the source code for each task generated if it "fits".
