<!--STATUS
state: LIVE (reference spec, user-provided 2026-09-14)
updated: 2026-09-14
current-answer: this is the AUTHORITATIVE BDC/NED "descriptors + entity + ownership" data-model spec.
  Our implementation must COMPLY with it, especially the generic OwnershipUpdate ownership-transfer
  message (per-descriptor, can originate EXTERNALLY) and the disposal rules.
