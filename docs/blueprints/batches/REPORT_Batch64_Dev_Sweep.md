...
| **Batch 61 (`W5`)** — the netstandard2.0/net8.0 wall duplicates things with only a comment holding them | `BATCH-03-REPORT.md:100`, `2026-06` — ⛔ **described, never filed** *(corrected `2026-08-16`)* |
