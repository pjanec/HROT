...
| `Hrot.Editor.AiShared.Tests` | **2067 / 2069** — ⭐ +13 `SubtreeCycleDetectorTests` (`CE-339`) and +5 `AiDocumentViewStateBinderTests` (`CE-340`) and +4/+1 for `CE-342`/`CE-343`; ⛔ the SAME 1 red `Aie030`, **baselined pre-existing** |
