...
Implements `IEntityAwareImGuiRenderer`, decorated with `[ImGuiRenderer(typeof(BTreeTraceWorkingMemory1024))]`. Pattern mirrors the root-params arm of [BlueprintBlackboard1024Renderer.cs](Hrot/Engine/Hrot.Presentation/Renderers/BlueprintBlackboard1024Renderer.cs):
