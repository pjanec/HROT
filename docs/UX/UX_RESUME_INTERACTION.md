...
| ◐ **[Architect_Question_28_Map_Layers.md](Architect_Question_28_Map_Layers.md)** | **UXI-28 decisions** — A/B/B″/C + overflow **settled**; **4 open**, chief among them the `ZIndex` draw-order migration |
