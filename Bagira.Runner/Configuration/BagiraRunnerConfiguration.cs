...
{
    /// <summary>
    /// Bagira-specific runner configuration extending the generic base.
    ///
    ...
    /// to Bagira's <see cref="RunMode"/> concept.</para>
    /// </summary>
    public class BagiraRunnerConfiguration : FDP.Framework.Runner.RunnerConfiguration
    {
        ...
        public void MergeFromJsonFile(string path)
        {
            ...
            var overrides = JsonConvert.DeserializeObject<BagiraRunnerConfiguration>(json);
