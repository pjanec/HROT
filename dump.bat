...
python C:\Utils\AITools\CodeDump\dump.py --filter-file no-tests-no-ext-FDP.dumpfilter . FDP.txt 
python C:\Utils\AITools\CodeDump\dump.py --filter-file no-tests-no-ext-HROT.dumpfilter . HROT.txt 
