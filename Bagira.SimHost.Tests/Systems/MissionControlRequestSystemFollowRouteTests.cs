...
namespace Bagira.SimHost.Tests.Systems;
...
public class MissionControlRequestSystemFollowRouteTests
{
        ...
        long vehicleNetId, long routeNetId, int trajectoryId)
    {
        ...
        repo.SetManagedComponent(vehicle, new Bagira.SimHost.Components.EntityMissionHolder());
    ...
    public void FollowRoute_RouteEntityFound_RewritesBehaviorParams()
    {
        ...
        var holder     = ((ISimulationView)repo).GetManagedComponentRO<Bagira.SimHost.Components.EntityMissionHolder>(vehicle);
