...
namespace Bagira.SimHost.Tests
{
    ...
    public sealed class CheckpointDsmHandlerTests : IDisposable
    {
        ...
        public CheckpointDsmHandlerTests()
        {
        ...
        /// is still in-flight, <c>LiveLoadDsmHandler.PrepareAsync</c> must not return
        ...
        public async Task LiveUnloading_WaitsForCheckpointDrain()
        {
            ...
            Assert.True(File.Exists(path),
                "Checkpoint file must exist after LiveLoadDsmHandler.PrepareAsync(FinalizeLive) returns.");
        }
    }
}
