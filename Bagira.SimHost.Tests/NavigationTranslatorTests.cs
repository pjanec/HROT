...
using DdsNavigationIntent = Bagira.BDC.SSTD.NavigationIntent;
using DdsNavigationStatus = Bagira.BDC.SSTD.NavigationStatus;
using ENavigationMode     = Bagira.BDC.SSTD.ENavigationMode;
using ENavigationResult   = Bagira.BDC.SSTD.ENavigationResult;
    ...
    public class NavigationTranslatorTests
    {
        ...
        public void NavigationIntentIngressTranslator_SetsComponent_WhenEntityKnown()
        {
            ...
            writer.Write(new DdsNavigationIntent
            {
                ...
                TargetSpeed      = 8f,
                ArrivalRadius    = 10f,
                FinalDestination = new GeoPosition { Latitude = 51.0, Longitude = 0.1, Altitude = 0.0 }
            });
            Thread.Sleep(200);
