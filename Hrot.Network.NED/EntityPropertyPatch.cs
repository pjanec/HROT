...
namespace Hrot.NED.Messages
{
    ...
    /// anonymous-object allocations in the ExCon.
    /// </para>
    ///
    /// <para>
    /// <b>ExCon serialization:</b> Serialize to JSON with
    ...
    ///
    /// <para>
    /// <b>SimHost creation path:</b> Passed as <see cref="Hrot.NED.Messages.CreateEntityRequest.InitialAttributes"/>
