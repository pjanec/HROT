...
/// <para>Covers:
/// <list type="bullet">
///   <item>OC1-I002: <see cref="ExConLogic.SendSetSelection"/> publishes CMD_SET_SELECTION and selects locally.</item>
///   <item>OC1-I003: <see cref="ExConLogic.CenterOnEntity"/> publishes CMD_SET_VIEW.</item>
///   <item>OC1-I004: <see cref="ExConLogic.DeleteEntity"/> publishes DeleteEntityRequest and tracks pending deletes.</item>
///   <item>OC1-I005: <see cref="ExConLogic.StartPersonalRouteAuthoring"/> publishes CMD_DRAW_PERSONAL_ROUTE.</item>
/// </list>
/// </para>
/// </summary>
public class ExConLogicContextCommandTests
{
    ...
    private static (
        ...
        Mock<IDdsWriter<Hrot.NED.Messages.DeleteEntityRequest>> DeleteWriter,
        ...
        CreateSut()
    {
        ...
        var deleteWriter      = new Mock<IDdsWriter<Hrot.NED.Messages.DeleteEntityRequest>>();
    ...
    public void DeleteEntity_PublishesDeleteEntityRequest()
    {
        ...
        deleteWriter.Verify(w => w.Write(It.Is<Hrot.NED.Messages.DeleteEntityRequest>(r =>
            r.EntityId == 5)),
            Times.Once);
    }
    ...
    public void DeleteEntity_FailureAck_ClearsPendingAndSetsAlert()
    {
        ...
        {
            EntityId   = 5,
            StatusCode = (int)NedStatusCode.UnknownDescriptorType, // any failure code
        });
        logic.Update();
