...
That probably conflicts with inline arrays (no struct allowed), what could be the workaround here?
Do we need to use inline arrays (restricted to primitive types) and fixed buffers (or are those also restricted)?
----------
[IDEA]
