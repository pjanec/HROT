...
namespace Bagira.SimHost.Integration.Tests
{
    ...
    ///
    /// <para>
    /// Root cause of the original bug: <c>BdcTkbBuilder.WithBehavior</c> did not
    ...
    ///
    /// <para>
    /// Fix: <see cref="Bagira.Map.Definitions.Tkb.BdcTkbBuilder.WithBehavior"/>
    ...
    public sealed class NavComponentsPresenceTests : System.IDisposable
    {
        ...
        public void SpawnedEntity_HasNavigationIntent_Component()
        {
            ...
            Assert.True(
                ...
                "(BdcTkbBuilder.WithBehavior must add it to the template).");
        }
        ...
        /// This reproduces the exact Bagira.Runner <c>-x all</c> crash scenario.
        /// </summary>
        [Fact]
        public void EntityMission_MoveToLocation_DoesNotThrowMissingNavigationIntent()
        {
            ...
            var mission = new Bagira.BDC.SSTD.EntityMission
            {
                ...
                Plan = new Bagira.BDC.SSTD.MissionPlan
                {
                    ...
                    {
                        new Bagira.BDC.SSTD.MissionTask
                        {
