...
namespace Hrot.SimHost.Systems
{
    public class MissionControlRequestSystem : ComponentSystem
    {
        ...
        protected override void OnUpdate()
        {
            ...
            for (int i = 0; i < retryCount; i++)
            {
                ...
                else
                {
                    ...
                    WriteAck(req.RequestId, NedStatusCode.EntityNotFound, EntityNotFoundMessage, newVersion: 0);
                }
            }
        ...
        private void ProcessRequest(EntityRepository repo, MissionControlRequest request)
        {
            ...
            switch (request.Payload._d)
            {
                case eMissionCommandType.CMD_REPLACE_MISSION:
                {
                    ...
                    {
                        WriteAck(request.RequestId, NedStatusCode.VersionConflict, VersionConflictMessage, newVersion: 0);
                        return;
                    }
                    ...
                    WriteAck(request.RequestId, NedStatusCode.Success, errorMessage: null, newVersion: currentVersion);
                ...
                default:
                    WriteAck(request.RequestId, NedStatusCode.NotSupported, "ERR_NOT_SUPPORTED", newVersion: 0);
                    return;
            }
        }
        ...
        private void WriteAck(Guid requestId, NedStatusCode errorCode, string? errorMessage, long newVersion)
        {
