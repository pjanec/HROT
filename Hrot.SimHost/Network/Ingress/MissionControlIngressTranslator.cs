...
namespace Hrot.SimHost.Network.Ingress
{
    /// <summary>
    ...
    /// <list type="bullet">
    ///   <item>Reads DDS wire messages — the only class that does so for mission control.</item>
    ...
    ///
    /// <para>
    /// <b>Not responsible for:</b> retry logic, entity resolution, version checking —
    ...
    public sealed class MissionControlIngressTranslator : IDescriptorTranslator
    {
        ...
        /// <summary>Production constructor — creates a live DDS reader.</summary>
        ...
        /// <summary>
        /// Internal test constructor — accepts a pre-built reader stub so tests run
