...
namespace Bagira.SimHost.Network
{
    ...
    /// for all locally-owned entities and publishes a DDS <see cref="Bagira.BDC.SSTD.NavigationStatus"/>
    /// sample for each.
    ///
    /// <para>
    ...
    {
        private readonly DdsWriter<Bagira.BDC.SSTD.NavigationStatus> _writer;
        ...
        {
            _writer    = new DdsWriter<Bagira.BDC.SSTD.NavigationStatus>(dds, "NavigationStatus");
        ...
        /// <summary>
        /// Publishes <see cref="Bagira.BDC.SSTD.NavigationStatus"/> to DDS for every
        ...
        public void ScanAndPublish(ISimulationView view)
        {
            ...
            foreach (var entity in query)
            {
                ...
                _writer.Write(new Bagira.BDC.SSTD.NavigationStatus
                {
