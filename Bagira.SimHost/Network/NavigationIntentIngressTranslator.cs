...
namespace Bagira.SimHost.Network
{
    ...
    ///
    /// <para>
    /// The wire <see cref="Bagira.DDS.DM.GeoPosition"/> is converted back to a
    ...
    {
        private readonly DdsReader<Bagira.BDC.SSTD.NavigationIntent> _reader;
        ...
        {
            _reader       = new DdsReader<Bagira.BDC.SSTD.NavigationIntent>(dds, "NavigationIntent");
