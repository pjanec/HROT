...
// Bagira-domain executors (JoinFormationExecutor, AimAndFireExecutor) via constructor
// injection so that the generic toolkit assembly carries no Bagira-domain references.
